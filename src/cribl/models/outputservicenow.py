...
class OutputServiceNowCompression(str, Enum):
...
class OutputServiceNowMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputServiceNowMetadata(BaseModel):
    value: str
...
class OutputServiceNowExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    name: NotRequired[str]


class OutputServiceNowExtraHTTPHeaders(BaseModel):
    value: str

    name: Optional[str] = None


class OutputServiceNowResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputServiceNowResponseRetrySettings(BaseModel):
...
class OutputServiceNowTypedDict(TypedDict):
    ...
    r"""Select a transport option for OpenTelemetry"""
    compress: NotRequired[OutputServiceNowCompression]
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: NotRequired[List[OutputServiceNowMetadataTypedDict]]
    ...
    extra_http_headers: NotRequired[List[OutputServiceNowExtraHTTPHeadersTypedDict]]
    r"""Headers to add to all events"""
    safe_headers: NotRequired[List[str]]
    r"""List of headers that are safe to log in plain text"""
    response_retry_settings: NotRequired[
        List[OutputServiceNowResponseRetrySettingsTypedDict]
    ]
...
class OutputServiceNow(BaseModel):
    ...
    compress: Optional[OutputServiceNowCompression] = OutputServiceNowCompression.GZIP
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: Optional[List[OutputServiceNowMetadata]] = None
    r"""List of key-value pairs to send with each gRPC request. Value supports JavaScript expressions that are evaluated just once, when the destination gets started. To pass credentials as metadata, use 'C.Secret'."""
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputServiceNowExtraHTTPHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputServiceNowResponseRetrySettings]],
