...
class OutputCrowdstrikeNextGenSiemResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputCrowdstrikeNextGenSiemResponseRetrySettings(BaseModel):
...
class OutputCrowdstrikeNextGenSiemTypedDict(TypedDict):
    url: str
    r"""URL provided from a CrowdStrike data connector, e.g. https://<your-api-key>.ingest.<your-region>.crowdstrike.com/services/collector"""
    id: NotRequired[str]
    ...
    response_retry_settings: NotRequired[
        List[OutputCrowdstrikeNextGenSiemResponseRetrySettingsTypedDict]
    ]
    ...
    r"""CrowdStrike Next-Gen SIEM authentication token"""
...
class OutputCrowdstrikeNextGenSiem(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputCrowdstrikeNextGenSiemResponseRetrySettings]],
