...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.create_team(description="once well-lit rigid anti", id="<id>", name="<value>", roles=[
        "<value 1>",
        "<value 2>",
        "<value 3>",
    ])
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_team()
...
**[models.GetTeamResponse](../../models/getteamresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_team_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.update_team_by_id(id_param="<value>", description="vibration below but once whoever and", id="<id>", name="<value>", roles=[
        "<value 1>",
        "<value 2>",
        "<value 3>",
    ])
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.delete_team_by_id(id="<id>")
...
**[models.DeleteTeamByIDResponse](../../models/deleteteambyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_team_acl_by_id(id="<id>")
...
**[models.GetTeamACLByIDResponse](../../models/getteamaclbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_team_roles_by_id(id="<id>")
...
**[models.GetTeamRolesByIDResponse](../../models/getteamrolesbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_team_users_by_id(id="<id>")
...
**[models.GetTeamUsersByIDResponse](../../models/getteamusersbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.create_team_users_by_id(id="<id>")
...
**[models.CreateTeamUsersByIDResponse](../../models/createteamusersbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.teams.get_products_groups_acl_teams_by_product_and_id(product=models.GetProductsGroupsACLTeamsByProductAndIDProduct.STREAM, id="<id>")
