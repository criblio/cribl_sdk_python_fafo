...
class InputKubeLogsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputKubeLogsConnections(BaseModel):
    output: str
...
class InputKubeLogsCompression(str, Enum):
...
class InputKubeLogsPqTypedDict(TypedDict):
    ...
    compress: NotRequired[InputKubeLogsCompression]
    r"""Codec to use to compress the persisted data"""
...
class InputKubeLogsPq(BaseModel):
    ...
    compress: Optional[InputKubeLogsCompression] = InputKubeLogsCompression.NONE
    r"""Codec to use to compress the persisted data"""


class InputKubeLogsRulesTypedDict(TypedDict):
    filter_: str
...
class InputKubeLogsRules(BaseModel):
...
class InputKubeLogsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputKubeLogsMetadata(BaseModel):
    name: str
...
class InputKubeLogsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputKubeLogsConnectionsTypedDict]]
    ...
    rules: NotRequired[List[InputKubeLogsRulesTypedDict]]
    ...
    metadata: NotRequired[List[InputKubeLogsMetadataTypedDict]]
...
class InputKubeLogs(BaseModel):
    ...
    connections: Optional[List[InputKubeLogsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    rules: Optional[List[InputKubeLogsRules]] = None
    r"""Add rules to decide which Pods to collect logs from. Logs are collected if no rules are given or if all the rules' expressions evaluate to true."""

    timestamps: Optional[bool] = False
    r"""For use when containers do not emit a timestamp, prefix each line of output with a timestamp. If you enable this setting, you can use the Kubernetes Logs Event Breaker and the kubernetes_logs Pre-processing Pipeline to remove them from the events after the timestamps are extracted."""

    metadata: Optional[List[InputKubeLogsMetadata]] = None
    r"""Fields to add to events from this input"""
