...
class InputAppscopeConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputAppscopeConnections(BaseModel):
    output: str
...
class InputAppscopeMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputAppscopeMetadata(BaseModel):
    name: str
...
class InputAppscopeTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputAppscopeConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputAppscopeMetadataTypedDict]]
...
class InputAppscope(BaseModel):
    ...
    connections: Optional[List[InputAppscopeConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputAppscopeMetadata]] = None
    r"""Fields to add to events from this input"""
