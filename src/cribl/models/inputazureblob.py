...
class InputAzureBlobConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputAzureBlobConnections(BaseModel):
    output: str
...
class InputAzureBlobMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputAzureBlobMetadata(BaseModel):
    name: str
...
class InputAzureBlobTypedDict(TypedDict):
    ...
    queue_name: str
    r"""The storage account queue name blob notifications will be read from. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. E.g., referencing a Global Variable: `myQueue-${C.vars.myVar}`"""
    id: NotRequired[str]
    ...
    connections: NotRequired[List[InputAzureBlobConnectionsTypedDict]]
...
class InputAzureBlob(BaseModel):
    ...
    connections: Optional[List[InputAzureBlobConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
