...
class SavedJobScheduledSearchType(str, Enum):
    COLLECTION = "collection"
...
class SavedJobScheduledSearchRunSettings(BaseModel):
    type: Optional[SavedJobScheduledSearchType] = None
    ...
    log_level: Annotated[
        Optional[SavedJobScheduledSearchLogLevel], pydantic.Field(alias="logLevel")
