...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.create_edge_appscope_processes(pid="<id>")
...
**[models.CreateEdgeAppscopeProcessesResponse](../../models/createedgeappscopeprocessesresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_appscope_processes()
...
**[models.GetEdgeAppscopeProcessesResponse](../../models/getedgeappscopeprocessesresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.delete_edge_appscope_processes_by_pid(pid="<id>")
...
**[models.DeleteEdgeAppscopeProcessesByPidResponse](../../models/deleteedgeappscopeprocessesbypidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_appscope_processes_by_pid(pid="<id>")
...
**[models.GetEdgeAppscopeProcessesByPidResponse](../../models/getedgeappscopeprocessesbypidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.update_edge_appscope_processes_by_pid(pid="<id>")
...
**[models.UpdateEdgeAppscopeProcessesByPidResponse](../../models/updateedgeappscopeprocessesbypidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_events_collectors()
...
**[models.GetEdgeEventsCollectorsResponse](../../models/getedgeeventscollectorsresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_fileinspect()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_ls_by_path(path="/usr/lib")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.create_products_edge_map_query()
...
**[models.CreateProductsEdgeMapQueryResponse](../../models/createproductsedgemapqueryresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_metadata()
...
**[models.GetEdgeMetadataResponse](../../models/getedgemetadataresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.create_edge_file_ingest()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_file_sample(path="/usr/ports")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.create_edge_kube_logs()
...
**[models.CreateEdgeKubeLogsResponse](../../models/createedgekubelogsresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_kube_proxy()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_containers_by_id(id="<id>")
...
**[models.GetEdgeContainersByIDResponse](../../models/getedgecontainersbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_containers()
...
**[models.GetEdgeContainersResponse](../../models/getedgecontainersresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_logs()
...
**[models.GetEdgeLogsResponse](../../models/getedgelogsresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_processes_by_pid(pid="<id>")
...
**[models.GetEdgeProcessesByPidResponse](../../models/getedgeprocessesbypidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.edge.get_edge_processes()
...
**[models.GetEdgeProcessesResponse](../../models/getedgeprocessesresponse.md)**
