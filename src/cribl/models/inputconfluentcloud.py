...
class InputConfluentCloudConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputConfluentCloudConnections(BaseModel):
    output: str
...
class InputConfluentCloudMetadata(BaseModel):
    name: str
...
class InputConfluentCloudTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputConfluentCloudConnectionsTypedDict]]
...
class InputConfluentCloud(BaseModel):
    ...
    connections: Optional[List[InputConfluentCloudConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
