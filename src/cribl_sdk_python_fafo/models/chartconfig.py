...
class ColorThresholdsTypedDict(TypedDict):
    thresholds: List[ThresholdTypedDict]
...
CustomDataPointScaleTypedDict = TypeAliasType(
    "CustomDataPointScaleTypedDict", Union[str, float]
)


CustomDataPointScale = TypeAliasType("CustomDataPointScale", Union[str, float])
...
class CustomDataTypedDict(TypedDict):
    ...
    point_scale: NotRequired[CustomDataPointScaleTypedDict]
...
class CustomData(BaseModel):
    ...
    point_scale: Annotated[
        Optional[CustomDataPointScale], pydantic.Field(alias="pointScale")
    ] = None
...
MapDetailsPointScaleTypedDict = TypeAliasType(
    "MapDetailsPointScaleTypedDict", Union[str, float]
)


MapDetailsPointScale = TypeAliasType("MapDetailsPointScale", Union[str, float])
...
class MapDetailsTypedDict(TypedDict):
    ...
    name_field: NotRequired[str]
    point_scale: NotRequired[MapDetailsPointScaleTypedDict]
...
class MapDetails(BaseModel):
    ...
    point_scale: Annotated[
        Optional[MapDetailsPointScale], pydantic.Field(alias="pointScale")
    ] = None
...
class OnClickActionTypedDict(TypedDict):
    ...
    selected_link_id: NotRequired[str]
...
class OnClickAction(BaseModel):
    ...
    selected_link_id: Annotated[
        Optional[str], pydantic.Field(alias="selectedLinkId")
    ] = None
