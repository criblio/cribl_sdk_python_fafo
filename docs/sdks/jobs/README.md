...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.get_job_results_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.update_jobs_cancel_by_id(id="<id>")
...
**[models.UpdateJobsCancelByIDResponse](../../models/updatejobscancelbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.create_jobs(request={
        "type": models.SavedJobExecutorJobType.SCHEDULED_SEARCH,
        "ttl": "4h",
...
**[models.CreateJobsResponse](../../models/createjobsresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.delete_jobs_by_id(id="<id>")
...
**[models.DeleteJobsByIDResponse](../../models/deletejobsbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.get_jobs_by_id(id="<id>")
...
**[models.GetJobsByIDResponse](../../models/getjobsbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.update_jobs_keep_by_id(id="<id>")
...
**[models.UpdateJobsKeepByIDResponse](../../models/updatejobskeepbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.update_jobs_pause_by_id(id="<id>")
...
**[models.UpdateJobsPauseByIDResponse](../../models/updatejobspausebyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.update_jobs_resume_by_id(id="<id>")
...
**[models.UpdateJobsResumeByIDResponse](../../models/updatejobsresumebyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.get_jobs_results_by_id_and_group(id="<id>", group="<value>")
...
**[models.GetJobsResultsByIDAndGroupResponse](../../models/getjobsresultsbyidandgroupresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.get_jobs_errors_by_id_and_group(id="<id>", group="<value>")
...
**[models.GetJobsErrorsByIDAndGroupResponse](../../models/getjobserrorsbyidandgroupresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.jobs.get_jobs_errors_by_id(id="<id>")
...
**[models.GetJobsErrorsByIDResponse](../../models/getjobserrorsbyidresponse.md)**
