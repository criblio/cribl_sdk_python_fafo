...
class InputTCPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputTCPConnections(BaseModel):
    output: str
...
class InputTCPMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputTCPMetadata(BaseModel):
    name: str
...
class InputTCPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputTCPConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputTCPMetadataTypedDict]]
...
class InputTCP(BaseModel):
    ...
    connections: Optional[List[InputTCPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputTCPMetadata]] = None
    r"""Fields to add to events from this input"""
