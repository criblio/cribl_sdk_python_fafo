...
class InputCollectionMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCollectionMetadata(BaseModel):
    name: str
...
class InputCollectionTypedDict(TypedDict):
    ...
    connections: NotRequired[List[ConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[PqTypedDict]
    ...
    metadata: NotRequired[List[InputCollectionMetadataTypedDict]]
...
class InputCollection(BaseModel):
    ...
    connections: Optional[List[Connections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCollectionMetadata]] = None
    r"""Fields to add to events from this input"""
