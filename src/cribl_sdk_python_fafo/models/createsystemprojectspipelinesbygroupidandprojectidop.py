...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDRequestTypedDict(TypedDict):
    group_id: str
    r"""Group Id"""
    project_id: str
    r"""Project Id"""
...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDRequest(BaseModel):
    group_id: Annotated[
        str,
...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDResponseTypedDict(TypedDict):
...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDResponse(BaseModel):
    r"""A list of Pipeline objects for specified Project"""
