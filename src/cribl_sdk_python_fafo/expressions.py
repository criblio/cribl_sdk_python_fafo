...
class Expressions(BaseSDK):
    r"""Actions related to expressions"""

    def create_lib_expression(
        self,
        *,
    ...
    ) -> models.CreateLibExpressionResponse:
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="createLibExpression",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CreateLibExpressionResponse
            )
    ...
    async def create_lib_expression_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
