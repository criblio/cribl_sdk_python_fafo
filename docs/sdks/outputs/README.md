...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.list_output()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.create_output(request={
        ...
        "timeout_sec": 30,
        "flush_period_sec": 1,
        "failed_request_logging_mode": models.OutputElasticFailedRequestLoggingMode.NONE,
        ...
        "on_backpressure": models.OutputElasticBackpressureBehavior.BLOCK,
        ...
        "pq_compress": models.OutputElasticCompression.NONE,
        "pq_on_backpressure": models.OutputElasticQueueFullBehavior.BLOCK,
        "pq_mode": models.OutputElasticMode.ERROR,
    })
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.get_output_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.update_output_by_id(id="<id>", output={
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.delete_output_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.delete_output_pq_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.get_output_pq_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.get_output_samples_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.create_output_test_by_id(id="<id>", events=[
        {
            "raw": "<value>",
        },
    ])
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.list_output_status()
...
**[models.ListOutputStatusResponse](../../models/listoutputstatusresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.outputs.get_output_status_by_id(id="<id>")
...
**[models.GetOutputStatusByIDResponse](../../models/getoutputstatusbyidresponse.md)**
