...
class KMSProviderConfigAuth2TypedDict(TypedDict):
...
class KMSProviderConfigAuth2(BaseModel):
...
class KMSProviderConfigAuth1TypedDict(TypedDict):
...
class KMSProviderConfigAuth1(BaseModel):
    provider: AuthProvider
...
AuthTypedDict = TypeAliasType(
    "AuthTypedDict",
    Union[KMSProviderConfigAuth2TypedDict, KMSProviderConfigAuth1TypedDict],
)


Auth = TypeAliasType("Auth", Union[KMSProviderConfigAuth2, KMSProviderConfigAuth1])
