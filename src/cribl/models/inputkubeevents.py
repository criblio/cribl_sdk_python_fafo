...
class InputKubeEventsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputKubeEventsConnections(BaseModel):
    output: str
...
class InputKubeEventsRulesTypedDict(TypedDict):
    filter_: str
...
class InputKubeEventsRules(BaseModel):
...
class InputKubeEventsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputKubeEventsMetadata(BaseModel):
    name: str
...
class InputKubeEventsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputKubeEventsConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputKubeEventsPqTypedDict]
    rules: NotRequired[List[InputKubeEventsRulesTypedDict]]
    r"""Filtering on event fields"""
    metadata: NotRequired[List[InputKubeEventsMetadataTypedDict]]
...
class InputKubeEvents(BaseModel):
    ...
    connections: Optional[List[InputKubeEventsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputKubeEventsPq] = None

    rules: Optional[List[InputKubeEventsRules]] = None
    r"""Filtering on event fields"""

    metadata: Optional[List[InputKubeEventsMetadata]] = None
    r"""Fields to add to events from this input"""
