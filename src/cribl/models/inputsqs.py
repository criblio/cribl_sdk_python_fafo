...
class InputSqsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSqsConnections(BaseModel):
    output: str
...
class InputSqsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSqsMetadata(BaseModel):
    name: str
...
class InputSqsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSqsConnectionsTypedDict]]
...
class InputSqs(BaseModel):
    ...
    connections: Optional[List[InputSqsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputSqsPq] = None

    queue_type: Annotated[Optional[QueueType], pydantic.Field(alias="queueType")] = (
        QueueType.STANDARD
    )
    r"""The queue type used (or created). Defaults to Standard"""
    ...
    metadata: Optional[List[InputSqsMetadata]] = None
    r"""Fields to add to events from this input"""
