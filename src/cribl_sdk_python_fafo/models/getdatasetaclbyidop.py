...
class GetDatasetACLByIDRequestTypedDict(TypedDict):
    id: str
    r"""Unique ID for ACL Get"""


class GetDatasetACLByIDRequest(BaseModel):
    id: Annotated[
...
class GetDatasetACLByIDResponseTypedDict(TypedDict):
...
class GetDatasetACLByIDResponse(BaseModel):
    r"""a list of UserAccessControlList objects"""
