...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.regexes.list_regex_lib_entry()
...
**[models.ListRegexLibEntryResponse](../../models/listregexlibentryresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.regexes.create_regex_lib_entry(id="<id>", regex="<value>")
...
**[models.CreateRegexLibEntryResponse](../../models/createregexlibentryresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.regexes.get_regex_lib_entry_by_id(id="<id>")
...
**[models.GetRegexLibEntryByIDResponse](../../models/getregexlibentrybyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.regexes.update_regex_lib_entry_by_id(id_param="<value>", id="<id>", regex="<value>")
...
**[models.UpdateRegexLibEntryByIDResponse](../../models/updateregexlibentrybyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.regexes.delete_regex_lib_entry_by_id(id="<id>")
...
**[models.DeleteRegexLibEntryByIDResponse](../../models/deleteregexlibentrybyidresponse.md)**
