...
class OutputDatadogExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    name: NotRequired[str]


class OutputDatadogExtraHTTPHeaders(BaseModel):
    value: str
...
class OutputDatadogResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputDatadogResponseRetrySettings(BaseModel):
...
class OutputDatadogTypedDict(TypedDict):
    ...
    r"""When enabled, batches events by API key and the ddtags field on the event. When disabled, batches events only by API key. If incoming events have high cardinality in the ddtags field, disabling this setting may improve Destination performance."""
    ...
    extra_http_headers: NotRequired[List[OutputDatadogExtraHTTPHeadersTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputDatadogResponseRetrySettingsTypedDict]
    ]
...
class OutputDatadog(BaseModel):
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputDatadogExtraHTTPHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputDatadogResponseRetrySettings]],
