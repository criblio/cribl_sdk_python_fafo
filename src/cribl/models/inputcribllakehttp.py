...
class InputCriblLakeHTTPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCriblLakeHTTPConnections(BaseModel):
    output: str
...
class InputCriblLakeHTTPMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCriblLakeHTTPMetadata(BaseModel):
    name: str
...
class InputCriblLakeHTTPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCriblLakeHTTPConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputCriblLakeHTTPMetadataTypedDict]]
...
class InputCriblLakeHTTP(BaseModel):
    ...
    connections: Optional[List[InputCriblLakeHTTPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCriblLakeHTTPMetadata]] = None
    r"""Fields to add to events from this input"""
