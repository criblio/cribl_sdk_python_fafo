...
class InputElasticConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputElasticConnections(BaseModel):
    output: str
...
class InputElasticMetadata(BaseModel):
    name: str
...
class InputElasticTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputElasticConnectionsTypedDict]]
    ...
    r"""Whether to ignore extra HTTP headers that don't start with X- or x-"""
    proxy_mode: NotRequired[ProxyModeTypedDict]
...
class InputElastic(BaseModel):
    ...
    connections: Optional[List[InputElasticConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    ignore_standard_headers: Annotated[
        Optional[bool], pydantic.Field(alias="ignoreStandardHeaders")
    ] = False
    r"""Whether to ignore extra HTTP headers that don't start with X- or x-"""

    proxy_mode: Annotated[Optional[ProxyMode], pydantic.Field(alias="proxyMode")] = None
