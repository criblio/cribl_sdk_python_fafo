...
class InputDatadogAgentConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputDatadogAgentConnections(BaseModel):
    output: str
...
class InputDatadogAgentMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputDatadogAgentMetadata(BaseModel):
    name: str
...
class InputDatadogAgentTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputDatadogAgentConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputDatadogAgentMetadataTypedDict]]
...
class InputDatadogAgent(BaseModel):
    ...
    connections: Optional[List[InputDatadogAgentConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputDatadogAgentMetadata]] = None
    r"""Fields to add to events from this input"""
