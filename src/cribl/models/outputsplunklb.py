...
class OutputSplunkLbAuthTokensTypedDict(TypedDict):
...
class OutputSplunkLbAuthTokens(BaseModel):
    auth_type: Annotated[
        Optional[OutputSplunkLbIndexerDiscoveryConfigsAuthTokensAuthenticationMethod],
        pydantic.Field(alias="authType"),
    ] = OutputSplunkLbIndexerDiscoveryConfigsAuthTokensAuthenticationMethod.MANUAL
    r"""Select Manual to enter an auth token directly, or select Secret to use a text secret to authenticate"""
...
class IndexerDiscoveryConfigsTypedDict(TypedDict):
    ...
    auth_tokens: NotRequired[List[OutputSplunkLbAuthTokensTypedDict]]
...
class IndexerDiscoveryConfigs(BaseModel):
    ...
    auth_tokens: Annotated[
        Optional[List[OutputSplunkLbAuthTokens]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Tokens required to authenticate to cluster manager for indexer discovery"""
...
class HostsTypedDict(TypedDict):
    host: str
