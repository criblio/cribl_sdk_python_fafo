...
class OutputSecurityLakeKeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputSecurityLakeKeyValueMetadata(BaseModel):
    value: str
...
class OutputSecurityLakeTypedDict(TypedDict):
    ...
    r"""Storage class to select for uploaded objects."""
    server_side_encryption: NotRequired[OutputSecurityLakeServerSideEncryption]
    r"""Server-side encryption for uploaded objects."""
    ...
    key_value_metadata: NotRequired[List[OutputSecurityLakeKeyValueMetadataTypedDict]]
...
class OutputSecurityLake(BaseModel):
    ...
    server_side_encryption: Annotated[
        Optional[OutputSecurityLakeServerSideEncryption],
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputSecurityLakeKeyValueMetadata]],
