...
class InputNetflowConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputNetflowConnections(BaseModel):
    output: str
...
class InputNetflowMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputNetflowMetadata(BaseModel):
    name: str
...
class InputNetflowTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputNetflowConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputNetflowMetadataTypedDict]]
...
class InputNetflow(BaseModel):
    ...
    connections: Optional[List[InputNetflowConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputNetflowMetadata]] = None
    r"""Fields to add to events from this input"""
