...
class OutputGoogleCloudStorageKeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputGoogleCloudStorageKeyValueMetadata(BaseModel):
    value: str
...
class OutputGoogleCloudStorageTypedDict(TypedDict):
    ...
    compress: NotRequired[OutputGoogleCloudStorageCompress]
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: NotRequired[
        List[OutputGoogleCloudStorageKeyValueMetadataTypedDict]
    ]
...
class OutputGoogleCloudStorage(BaseModel):
    ...
    compress: Optional[OutputGoogleCloudStorageCompress] = (
        OutputGoogleCloudStorageCompress.GZIP
    )
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputGoogleCloudStorageKeyValueMetadata]],
