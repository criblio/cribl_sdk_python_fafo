...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.list_lookup_file()
...
**[models.ListLookupFileResponse](../../models/listlookupfileresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.create_lookup_file(request={
        "id": "<id>",
        "mode": models.LookupFileMode1.MEMORY,
    })
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `request`                                                           | [models.LookupFileInputUnion](../../models/lookupfileinputunion.md) | :heavy_check_mark:                                                  | The request object to use for the request.                          |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |

### Response

**[models.CreateLookupFileResponse](../../models/createlookupfileresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.update_lookup_file(request_body="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.get_lookup_file_by_id(id="<id>")
...
**[models.GetLookupFileByIDResponse](../../models/getlookupfilebyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.update_lookup_file_by_id(id="<id>", lookup_file={
        "id": "<id>",
        "mode": models.LookupFileMode1.MEMORY,
    })
...
**[models.UpdateLookupFileByIDResponse](../../models/updatelookupfilebyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.lookups.delete_lookup_file_by_id(id="<id>")
...
**[models.DeleteLookupFileByIDResponse](../../models/deletelookupfilebyidresponse.md)**
