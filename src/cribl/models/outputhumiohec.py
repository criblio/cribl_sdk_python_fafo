...
class OutputHumioHecExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    r"""Field value"""
...
class OutputHumioHecExtraHTTPHeaders(BaseModel):
    value: str
    r"""Field value"""
...
class OutputHumioHecResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputHumioHecResponseRetrySettings(BaseModel):
...
class OutputHumioHecTypedDict(TypedDict):
    ...
    extra_http_headers: NotRequired[List[OutputHumioHecExtraHTTPHeadersTypedDict]]
    ...
    format_: NotRequired[RequestFormat]
    r"""When set to JSON, the event is automatically formatted with required fields before sending. When set to Raw, only the event's `_raw` value is sent."""
    auth_type: NotRequired[OutputHumioHecAuthenticationMethod]
    r"""Select Manual to enter an auth token directly, or select Secret to use a text secret to authenticate"""
    response_retry_settings: NotRequired[
        List[OutputHumioHecResponseRetrySettingsTypedDict]
    ]
...
class OutputHumioHec(BaseModel):
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputHumioHecExtraHTTPHeaders]],
    ...
    format_: Annotated[Optional[RequestFormat], pydantic.Field(alias="format")] = (
        RequestFormat.JSON
    )
    r"""When set to JSON, the event is automatically formatted with required fields before sending. When set to Raw, only the event's `_raw` value is sent."""
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputHumioHecResponseRetrySettings]],
