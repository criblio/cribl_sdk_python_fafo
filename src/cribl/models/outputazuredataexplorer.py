...
class OutputAzureDataExplorerDiskSpaceProtection(str, Enum):
    r"""Whether to block or drop events when disk space is below the global 'Min free disk space' limit"""
...
class ExtentTagsTypedDict(TypedDict):
    value: str
    prefix: NotRequired[PrefixOptional]


class ExtentTags(BaseModel):
    value: str

    prefix: Optional[PrefixOptional] = None


class IngestIfNotExistsTypedDict(TypedDict):
    value: str


class IngestIfNotExists(BaseModel):
    value: str
...
class OutputAzureDataExplorerResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputAzureDataExplorerResponseRetrySettings(BaseModel):
...
class OutputAzureDataExplorerCompress(str, Enum):
    r"""Choose data compression format to apply to HTTP content before it is delivered."""

    NONE = "none"
    GZIP = "gzip"


class OutputAzureDataExplorerCompression(str, Enum):
...
class OutputAzureDataExplorerTypedDict(TypedDict):
    ...
    r"""When you save or start the Destination, validates database name and credentials; also validates table name except when creating a new table. Disable if your Azure app does not have both the Database Viewer and the Table Viewer role."""
    ...
    r"""Enable if you want to send a (JSON) mapping object instead of specifying an existing named data mapping."""
    ...
    r"""If a file fails to move to its final destination after the maximum number of retries, dead-letter it to prevent further errors."""
    timeout_sec: NotRequired[float]
    r"""Amount of time, in seconds, to wait for a request to complete before canceling it"""
    flush_immediately: NotRequired[bool]
    r"""Enable to bypass the data management service's aggregation mechanism."""
    retain_blob_on_success: NotRequired[bool]
    r"""Enable to prevent blob deletion after ingestion is complete."""
    extent_tags: NotRequired[List[ExtentTagsTypedDict]]
    r"""Strings or tags associated with the extent (ingested data shard)."""
    ingest_if_not_exists: NotRequired[List[IngestIfNotExistsTypedDict]]
    r"""Prevents duplicate ingestion by checking if an extent with the specified ingest-by tag already exists."""
    report_level: NotRequired[ReportLevel]
    r"""Level of ingestion status reporting. Defaults to FailuresOnly."""
    report_method: NotRequired[ReportMethod]
    r"""Target of the ingestion status reporting. Defaults to Queue."""
    additional_properties: NotRequired[List[AdditionalPropertiesTypedDict]]
    r"""Optionally, enter additional configuration properties to send to the ingestion service."""
    response_retry_settings: NotRequired[
        List[OutputAzureDataExplorerResponseRetrySettingsTypedDict]
    ]
    ...
    compress: NotRequired[OutputAzureDataExplorerCompress]
    r"""Choose data compression format to apply to HTTP content before it is delivered."""
    ...
    pq_compress: NotRequired[OutputAzureDataExplorerCompression]
    r"""Codec to use to compress the persisted data."""
...
class OutputAzureDataExplorer(BaseModel):
    ...
    extent_tags: Annotated[
        Optional[List[ExtentTags]], pydantic.Field(alias="extentTags")
    ] = None
    r"""Strings or tags associated with the extent (ingested data shard)."""

    ingest_if_not_exists: Annotated[
        Optional[List[IngestIfNotExists]], pydantic.Field(alias="ingestIfNotExists")
    ] = None
    r"""Prevents duplicate ingestion by checking if an extent with the specified ingest-by tag already exists."""
    ...
    additional_properties: Annotated[
        Optional[List[AdditionalProperties]],
        pydantic.Field(alias="additionalProperties"),
    ] = None
    r"""Optionally, enter additional configuration properties to send to the ingestion service."""

    response_retry_settings: Annotated[
        Optional[List[OutputAzureDataExplorerResponseRetrySettings]],
    ...
    compress: Optional[OutputAzureDataExplorerCompress] = (
        OutputAzureDataExplorerCompress.GZIP
    )
    r"""Choose data compression format to apply to HTTP content before it is delivered."""
    ...
    pq_compress: Annotated[
        Optional[OutputAzureDataExplorerCompression], pydantic.Field(alias="pqCompress")
    ] = OutputAzureDataExplorerCompression.NONE
    r"""Codec to use to compress the persisted data."""
