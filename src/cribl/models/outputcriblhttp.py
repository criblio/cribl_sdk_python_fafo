...
class OutputCriblHTTPExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    r"""Field value"""
...
class OutputCriblHTTPExtraHTTPHeaders(BaseModel):
    value: str
    r"""Field value"""
...
class OutputCriblHTTPResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputCriblHTTPResponseRetrySettings(BaseModel):
...
class OutputCriblHTTPUrlsTypedDict(TypedDict):
    url: str
...
class OutputCriblHTTPUrls(BaseModel):
    url: str
    r"""URL of a Cribl Worker to send events to, e.g., http://localhost:10200"""
...
class OutputCriblHTTPTypedDict(TypedDict):
    ...
    extra_http_headers: NotRequired[List[OutputCriblHTTPExtraHTTPHeadersTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputCriblHTTPResponseRetrySettingsTypedDict]
    ]
    ...
    urls: NotRequired[List[OutputCriblHTTPUrlsTypedDict]]
...
class OutputCriblHTTP(BaseModel):
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputCriblHTTPExtraHTTPHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputCriblHTTPResponseRetrySettings]],
    ...
    urls: Optional[List[OutputCriblHTTPUrls]] = None
