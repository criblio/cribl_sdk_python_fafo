...
from cribl._hooks import AfterErrorContext, AfterSuccessContext, BeforeRequestContext
from cribl.utils import RetryConfig, SerializedRequestBody, get_body_content
import httpx
    ...
    def _build_request_with_client(
        ...
        if security is not None:
            if callable(security):
                security = security()
        security = utils.get_security_from_env(security, models.SecurityModel)
        if security is not None:
