...
class InputTcpjsonConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputTcpjsonConnections(BaseModel):
    output: str
...
class InputTcpjsonMetadata(BaseModel):
    name: str
...
class InputTcpjsonTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputTcpjsonConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputTcpjsonMetadataTypedDict]]
...
class InputTcpjson(BaseModel):
    ...
    connections: Optional[List[InputTcpjsonConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputTcpjsonMetadata]] = None
    r"""Fields to add to events from this input"""
