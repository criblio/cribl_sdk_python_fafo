...
class InputKinesisConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputKinesisConnections(BaseModel):
    output: str
...
class InputKinesisMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputKinesisMetadata(BaseModel):
    name: str
...
class InputKinesisTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputKinesisConnectionsTypedDict]]
...
class InputKinesis(BaseModel):
    ...
    connections: Optional[List[InputKinesisConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
