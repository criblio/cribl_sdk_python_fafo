...
class InputJournalFilesConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputJournalFilesConnections(BaseModel):
    output: str
...
class InputJournalFilesRulesTypedDict(TypedDict):
    filter_: str
...
class InputJournalFilesRules(BaseModel):
...
class InputJournalFilesMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputJournalFilesMetadata(BaseModel):
    name: str
...
class InputJournalFilesTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputJournalFilesConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputJournalFilesPqTypedDict]
    interval: NotRequired[float]
    r"""Time, in seconds, between scanning for journals."""
    rules: NotRequired[List[InputJournalFilesRulesTypedDict]]
    ...
    metadata: NotRequired[List[InputJournalFilesMetadataTypedDict]]
...
class InputJournalFiles(BaseModel):
    ...
    connections: Optional[List[InputJournalFilesConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    rules: Optional[List[InputJournalFilesRules]] = None
    r"""Add rules to decide which journal objects to allow. Events are generated if no rules are given or if all the rules' expressions evaluate to true."""
    ...
    metadata: Optional[List[InputJournalFilesMetadata]] = None
    r"""Fields to add to events from this input"""
