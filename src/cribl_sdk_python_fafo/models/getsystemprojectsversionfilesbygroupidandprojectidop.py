...
class GetSystemProjectsVersionFilesByGroupIDAndProjectIDResponseTypedDict(TypedDict):
...
class GetSystemProjectsVersionFilesByGroupIDAndProjectIDResponse(BaseModel):
    r"""A list of GitFilesResponse objects"""
