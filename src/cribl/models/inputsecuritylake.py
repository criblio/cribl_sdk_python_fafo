...
class InputSecurityLakeConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSecurityLakeConnections(BaseModel):
    output: str
...
class InputSecurityLakeMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSecurityLakeMetadata(BaseModel):
    name: str
...
class InputSecurityLakeTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSecurityLakeConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputSecurityLakeMetadataTypedDict]]
...
class InputSecurityLake(BaseModel):
    ...
    connections: Optional[List[InputSecurityLakeConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputSecurityLakeMetadata]] = None
    r"""Fields to add to events from this input"""
