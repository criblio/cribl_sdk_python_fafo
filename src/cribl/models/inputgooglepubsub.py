...
class InputGooglePubsubConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputGooglePubsubConnections(BaseModel):
    output: str
...
class InputGooglePubsubMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputGooglePubsubMetadata(BaseModel):
    name: str
...
class InputGooglePubsubTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputGooglePubsubConnectionsTypedDict]]
...
class InputGooglePubsub(BaseModel):
    ...
    connections: Optional[List[InputGooglePubsubConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
