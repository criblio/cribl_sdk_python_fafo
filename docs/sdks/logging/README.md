...
with Cribl(
    ...
    res = c_client.logging.get_system_jobs_logs_by_id_and_group_id(id="<id>", group_id="<id>")
...
**[models.GetSystemJobsLogsByIDAndGroupIDResponseBody](../../models/getsystemjobslogsbyidandgroupidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.logging.get_system_logs_by_id(id="<id>")
...
**[models.GetSystemLogsByIDResponseBody](../../models/getsystemlogsbyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.logging.get_system_logs()
...
**[models.GetSystemLogsResponseBody](../../models/getsystemlogsresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.logging.get_system_logs_search(type_="<value>")
...
**[models.GetSystemLogsSearchResponseBody](../../models/getsystemlogssearchresponsebody.md)**
