...
class CreatePipelineByPackRequestTypedDict(TypedDict):
    pack: str
    r"""pack ID to POST"""
...
class CreatePipelineByPackRequest(BaseModel):
    pack: Annotated[
...
class CreatePipelineByPackResponseBodyTypedDict(TypedDict):
...
class CreatePipelineByPackResponseBody(BaseModel):
    r"""a list of Pipeline objects"""
