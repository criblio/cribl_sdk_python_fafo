...
with Cribl(
    ...
    res = c_client.saved_queries.list_saved_query()
...
**[models.ListSavedQueryResponseBody](../../models/listsavedqueryresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.saved_queries.create_saved_query(id="<id>", name="<value>", query="<value>")
...
**[models.CreateSavedQueryResponseBody](../../models/createsavedqueryresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.saved_queries.get_saved_query_by_id(id="<id>")
...
**[models.GetSavedQueryByIDResponseBody](../../models/getsavedquerybyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.saved_queries.update_saved_query_by_id(id_param="<value>", id="<id>", name="<value>", query="<value>")
...
**[models.UpdateSavedQueryByIDResponseBody](../../models/updatesavedquerybyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.saved_queries.delete_saved_query_by_id(id="<id>")
...
**[models.DeleteSavedQueryByIDResponseBody](../../models/deletesavedquerybyidresponsebody.md)**
