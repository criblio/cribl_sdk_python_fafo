...
class InputEventhubConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputEventhubConnections(BaseModel):
    output: str
...
class InputEventhubMetadata(BaseModel):
    name: str
...
class InputEventhubTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputEventhubConnectionsTypedDict]]
...
class InputEventhub(BaseModel):
    ...
    connections: Optional[List[InputEventhubConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
