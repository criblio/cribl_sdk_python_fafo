...
class InputRawUDPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputRawUDPConnections(BaseModel):
    output: str
...
class InputRawUDPMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputRawUDPMetadata(BaseModel):
    name: str
...
class InputRawUDPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputRawUDPConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputRawUDPMetadataTypedDict]]
...
class InputRawUDP(BaseModel):
    ...
    connections: Optional[List[InputRawUDPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputRawUDPMetadata]] = None
    r"""Fields to add to events from this input"""
