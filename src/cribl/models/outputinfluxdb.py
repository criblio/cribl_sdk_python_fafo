...
class OutputInfluxdbResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputInfluxdbResponseRetrySettings(BaseModel):
...
class OutputInfluxdbOauthParamsTypedDict(TypedDict):
    name: str
...
class OutputInfluxdbOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class OutputInfluxdbOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class OutputInfluxdbOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class OutputInfluxdbTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputInfluxdbResponseRetrySettingsTypedDict]
    ]
    ...
    oauth_params: NotRequired[List[OutputInfluxdbOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[OutputInfluxdbOauthHeadersTypedDict]]
...
class OutputInfluxdb(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputInfluxdbResponseRetrySettings]],
    ...
    oauth_params: Annotated[
        Optional[List[OutputInfluxdbOauthParams]], pydantic.Field(alias="oauthParams")
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[OutputInfluxdbOauthHeaders]], pydantic.Field(alias="oauthHeaders")
    ] = None
    r"""Additional headers to send in the OAuth login request. @{product} will automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
