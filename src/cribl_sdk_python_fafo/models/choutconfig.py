...
class CHOutConfigColumnMappingTypedDict(TypedDict):
    column_name: str
    column_type: str
    column_value_expression: str


class CHOutConfigColumnMapping(BaseModel):
...
class CHOutConfigURLTypedDict(TypedDict):
    pass


class CHOutConfigURL(BaseModel):
    pass
...
class CHOutConfigTypedDict(TypedDict):
    ...
    column_mappings: NotRequired[List[CHOutConfigColumnMappingTypedDict]]
    ...
    urls: NotRequired[List[CHOutConfigURLTypedDict]]
...
class CHOutConfig(BaseModel):
    ...
    column_mappings: Annotated[
        Optional[List[CHOutConfigColumnMapping]], pydantic.Field(alias="columnMappings")
    ] = None
    ...
    urls: Optional[List[CHOutConfigURL]] = None
