...
class TrustPolicies(BaseSDK):
    r"""Actions related to Trust Policies"""

    def list_trust_policy(
        self,
        *,
    ...
    ) -> models.ListTrustPolicyResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.ListTrustPolicyResponse)
    ...
    async def list_trust_policy_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
