...
class InputZscalerHecConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputZscalerHecConnections(BaseModel):
    output: str
...
class InputZscalerHecAuthTokensMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputZscalerHecAuthTokensMetadata(BaseModel):
    name: str
...
class InputZscalerHecAuthTokensTypedDict(TypedDict):
    token: Any
    ...
    metadata: NotRequired[List[InputZscalerHecAuthTokensMetadataTypedDict]]
    r"""Fields to add to events referencing this token"""


class InputZscalerHecAuthTokens(BaseModel):
    token: Any
    ...
    metadata: Optional[List[InputZscalerHecAuthTokensMetadata]] = None
    r"""Fields to add to events referencing this token"""
...
class InputZscalerHecMetadata(BaseModel):
    name: str
...
class InputZscalerHecTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputZscalerHecConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputZscalerHecPqTypedDict]
    host: NotRequired[str]
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    auth_tokens: NotRequired[List[InputZscalerHecAuthTokensTypedDict]]
    ...
    metadata: NotRequired[List[InputZscalerHecMetadataTypedDict]]
...
class InputZscalerHec(BaseModel):
    ...
    connections: Optional[List[InputZscalerHecConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    auth_tokens: Annotated[
        Optional[List[InputZscalerHecAuthTokens]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    ...
    metadata: Optional[List[InputZscalerHecMetadata]] = None
    r"""Fields to add to every event. May be overridden by fields added at the token or request level."""
