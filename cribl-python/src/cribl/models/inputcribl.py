...
class InputCriblConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCriblConnections(BaseModel):
    output: str
...
class InputCriblMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCriblMetadata(BaseModel):
    name: str
...
class InputCriblTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCriblConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputCriblPqTypedDict]
    filter_: NotRequired[str]
    metadata: NotRequired[List[InputCriblMetadataTypedDict]]
...
class InputCribl(BaseModel):
    ...
    connections: Optional[List[InputCriblConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCriblMetadata]] = None
    r"""Fields to add to events from this input"""
