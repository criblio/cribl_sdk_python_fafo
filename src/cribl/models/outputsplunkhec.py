...
class OutputSplunkHecResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputSplunkHecResponseRetrySettings(BaseModel):
...
class OutputSplunkHecUrlsTypedDict(TypedDict):
    url: NotRequired[str]
...
class OutputSplunkHecUrls(BaseModel):
...
class OutputSplunkHecTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputSplunkHecResponseRetrySettingsTypedDict]
    ]
    ...
    urls: NotRequired[List[OutputSplunkHecUrlsTypedDict]]
...
class OutputSplunkHec(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputSplunkHecResponseRetrySettings]],
    ...
    urls: Optional[List[OutputSplunkHecUrls]] = None
