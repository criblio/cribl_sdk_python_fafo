...
class OutputCriblTCPHostsTypedDict(TypedDict):
    host: str
...
class OutputCriblTCPHosts(BaseModel):
    host: str
    r"""The hostname of the receiver."""
...
class OutputCriblTCPTypedDict(TypedDict):
    ...
    hosts: NotRequired[List[OutputCriblTCPHostsTypedDict]]
...
class OutputCriblTCP(BaseModel):
    ...
    hosts: Optional[List[OutputCriblTCPHosts]] = None
    r"""Set of hosts to load-balance data to."""
