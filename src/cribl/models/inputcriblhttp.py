...
class InputCriblHTTPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCriblHTTPConnections(BaseModel):
    output: str
...
class InputCriblHTTPMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCriblHTTPMetadata(BaseModel):
    name: str
...
class InputCriblHTTPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCriblHTTPConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputCriblHTTPMetadataTypedDict]]
...
class InputCriblHTTP(BaseModel):
    ...
    connections: Optional[List[InputCriblHTTPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCriblHTTPMetadata]] = None
    r"""Fields to add to events from this input"""
