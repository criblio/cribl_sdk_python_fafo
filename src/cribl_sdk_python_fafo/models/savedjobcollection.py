...
class SavedJobCollectionRunType(str, Enum):
    COLLECTION = "collection"
...
class SavedJobCollectionRunSettings(BaseModel):
    type: Optional[SavedJobCollectionRunType] = None
...
class SavedJobCollectionCollectorSpecificSettingsTypedDict(TypedDict):
    pass


class SavedJobCollectionCollectorSpecificSettings(BaseModel):
    pass
...
class SavedJobCollectionCollectorTypedDict(TypedDict):
    ...
    conf: SavedJobCollectionCollectorSpecificSettingsTypedDict
...
class SavedJobCollectionCollector(BaseModel):
    ...
    conf: SavedJobCollectionCollectorSpecificSettings
