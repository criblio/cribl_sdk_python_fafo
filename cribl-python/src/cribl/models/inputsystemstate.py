...
class InputSystemStateConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSystemStateConnections(BaseModel):
    output: str
...
class InputSystemStateMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSystemStateMetadata(BaseModel):
    name: str
...
class CollectorsModelTypedDict(TypedDict):
...
class InputSystemStatePersistenceCompression(str, Enum):
...
class PersistenceTypedDict(TypedDict):
    enable: NotRequired[bool]
    ...
    compress: NotRequired[InputSystemStatePersistenceCompression]
    r"""Select data compression format. Optional."""
...
class Persistence(BaseModel):
    ...
    compress: Optional[InputSystemStatePersistenceCompression] = (
        InputSystemStatePersistenceCompression.NONE
    )
    r"""Select data compression format. Optional."""
...
class InputSystemStateTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSystemStateConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputSystemStatePqTypedDict]
    interval: NotRequired[float]
    r"""Time, in seconds, between consecutive state collections. Default is 300 seconds. (i.e. 5 minutes)"""
    metadata: NotRequired[List[InputSystemStateMetadataTypedDict]]
    r"""Fields to add to events from this input"""
    collectors: NotRequired[CollectorsModelTypedDict]
    persistence: NotRequired[PersistenceTypedDict]
...
class InputSystemState(BaseModel):
    ...
    connections: Optional[List[InputSystemStateConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputSystemStateMetadata]] = None
    r"""Fields to add to events from this input"""

    collectors: Optional[CollectorsModel] = None
