...
class OutputAzureBlobKeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputAzureBlobKeyValueMetadata(BaseModel):
    value: str
...
class OutputAzureBlobTypedDict(TypedDict):
    ...
    compress: NotRequired[OutputAzureBlobCompress]
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: NotRequired[List[OutputAzureBlobKeyValueMetadataTypedDict]]
    ...
    r"""Endpoint suffix for the service URL. Defaults to core.windows.net."""
...
class OutputAzureBlob(BaseModel):
    ...
    compress: Optional[OutputAzureBlobCompress] = OutputAzureBlobCompress.GZIP
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputAzureBlobKeyValueMetadata]],
