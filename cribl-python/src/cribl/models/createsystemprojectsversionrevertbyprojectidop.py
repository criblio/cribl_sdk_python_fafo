...
class CreateSystemProjectsVersionRevertByProjectIDRequestTypedDict(TypedDict):
    project_id: str
    r"""Project Id"""
...
class CreateSystemProjectsVersionRevertByProjectIDRequest(BaseModel):
...
class CreateSystemProjectsVersionRevertByProjectIDResponseBodyTypedDict(TypedDict):
...
class CreateSystemProjectsVersionRevertByProjectIDResponseBody(BaseModel):
    r"""a list of GitRevertResult objects"""
