...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("CRIBLSDKPYTHONFAFO_BEARER_AUTH"):
        security_dict["bearer_auth"] = os.getenv("CRIBLSDKPYTHONFAFO_BEARER_AUTH")

    if os.getenv("CRIBLSDKPYTHONFAFO_CLIENT_ID"):
        security_dict.setdefault("client_oauth", {})["client_id"] = os.getenv(
            "CRIBLSDKPYTHONFAFO_CLIENT_ID"
        )

    if os.getenv("CRIBLSDKPYTHONFAFO_CLIENT_SECRET"):
        security_dict.setdefault("client_oauth", {})["client_secret"] = os.getenv(
            "CRIBLSDKPYTHONFAFO_CLIENT_SECRET"
        )

    if os.getenv("CRIBLSDKPYTHONFAFO_TOKEN_URL"):
        security_dict.setdefault("client_oauth", {})["token_url"] = os.getenv(
            "CRIBLSDKPYTHONFAFO_TOKEN_URL"
        )
