...
class OutputDlS3KeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputDlS3KeyValueMetadata(BaseModel):
    value: str
...
class OutputDlS3TypedDict(TypedDict):
    ...
    r"""Storage class to select for uploaded objects."""
    server_side_encryption: NotRequired[OutputDlS3ServerSideEncryption]
    r"""Server-side encryption for uploaded objects."""
    ...
    key_value_metadata: NotRequired[List[OutputDlS3KeyValueMetadataTypedDict]]
...
class OutputDlS3(BaseModel):
    ...
    server_side_encryption: Annotated[
        Optional[OutputDlS3ServerSideEncryption],
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputDlS3KeyValueMetadata]],
