...
class ResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class ResponseRetrySettings(BaseModel):
...
class TimeoutRetrySettingsTypedDict(TypedDict):
...
class TimeoutRetrySettings(BaseModel):
...
class PqControlsTypedDict(TypedDict):
    pass


class PqControls(BaseModel):
    pass


class OutputWebhookOauthParamsTypedDict(TypedDict):
    name: str
...
class OutputWebhookOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class OutputWebhookOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class OutputWebhookOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class OutputWebhookTypedDict(TypedDict):
    ...
    extra_http_headers: NotRequired[List[OutputWebhookExtraHTTPHeadersTypedDict]]
    ...
    failed_request_logging_mode: NotRequired[FailedRequestLoggingMode]
    r"""Data to log when a request fails. All headers are redacted by default, unless listed as safe headers below."""
    safe_headers: NotRequired[List[str]]
    r"""List of headers that are safe to log in plain text"""
    response_retry_settings: NotRequired[List[ResponseRetrySettingsTypedDict]]
    r"""Automatically retry after unsuccessful response status codes, such as 429 (Too Many Requests) or 503 (Service Unavailable)."""
    timeout_retry_settings: NotRequired[TimeoutRetrySettingsTypedDict]
    response_honor_retry_after_header: NotRequired[bool]
    r"""Honor any Retry-After header that specifies a delay (in seconds) no longer than 180 seconds after the retry request. @{product} limits the delay to 180 seconds, even if the Retry-After header specifies a longer delay. When enabled, takes precedence over user-configured retry options. When disabled, all Retry-After headers are ignored."""
    on_backpressure: NotRequired[BackpressureBehavior]
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    oauth_params: NotRequired[List[OutputWebhookOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[OutputWebhookOauthHeadersTypedDict]]
    r"""Additional headers to send in the OAuth login request. @{product} will automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
    url: NotRequired[str]
    r"""URL of a webhook endpoint to send events to, such as http://localhost:10200"""
    exclude_self: NotRequired[bool]
    r"""Exclude all IPs of the current host from the list of any resolved hostnames."""
    urls: NotRequired[List[UrlsTypedDict]]
...
class OutputWebhook(BaseModel):
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputWebhookExtraHTTPHeaders]],
    ...
    failed_request_logging_mode: Annotated[
        Optional[FailedRequestLoggingMode],
    ...
    response_retry_settings: Annotated[
        Optional[List[ResponseRetrySettings]],
        pydantic.Field(alias="responseRetrySettings"),
    ] = None
    r"""Automatically retry after unsuccessful response status codes, such as 429 (Too Many Requests) or 503 (Service Unavailable)."""

    timeout_retry_settings: Annotated[
        Optional[TimeoutRetrySettings], pydantic.Field(alias="timeoutRetrySettings")
    ] = None
    ...
    on_backpressure: Annotated[
        Optional[BackpressureBehavior], pydantic.Field(alias="onBackpressure")
    ...
    pq_on_backpressure: Annotated[
        Optional[QueueFullBehavior], pydantic.Field(alias="pqOnBackpressure")
    ...
    pq_controls: Annotated[Optional[PqControls], pydantic.Field(alias="pqControls")] = (
        None
    )
    ...
    oauth_params: Annotated[
        Optional[List[OutputWebhookOauthParams]], pydantic.Field(alias="oauthParams")
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[OutputWebhookOauthHeaders]], pydantic.Field(alias="oauthHeaders")
    ] = None
    r"""Additional headers to send in the OAuth login request. @{product} will automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
