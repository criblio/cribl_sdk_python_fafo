...
class DeleteSubscriptionByIDRequestTypedDict(TypedDict):
    id: str
    r"""Subscription ID"""


class DeleteSubscriptionByIDRequest(BaseModel):
    id: Annotated[
...
class DeleteSubscriptionByIDResponseTypedDict(TypedDict):
