...
from cribl_sdk_python_fafo.httpclient import HttpClient
from cribl_sdk_python_fafo.sdkconfiguration import SDKConfiguration
...
class Credentials:
    ...
    def __init__(self, client_id: str, client_secret: str, token_url: str):
        ...
        self.audience = os.getenv("CRIBL_AUDIENCE", "https://api.cribl.cloud") # Set default audience here
