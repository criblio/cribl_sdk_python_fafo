...
class Changelog(BaseSDK):
    r"""Actions related to Changelog"""

    def get_changelog_viewed(
        self,
        *,
    ...
    ) -> models.GetChangelogViewedResponse:
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getChangelogViewed",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetChangelogViewedResponse
            )
    ...
    async def get_changelog_viewed_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
