...
class GetProductsGroupsByProductPathParamProduct(str, Enum):
    r"""Cribl Product"""
...
class GetProductsGroupsByProductRequestTypedDict(TypedDict):
    product: GetProductsGroupsByProductPathParamProduct
    r"""Cribl Product"""
...
class GetProductsGroupsByProductResponseBodyTypedDict(TypedDict):
...
class GetProductsGroupsByProductResponseBody(BaseModel):
    r"""a list of ConfigGroup objects"""
