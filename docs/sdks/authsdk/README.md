...
* [delete_auth_users_invalidation_by_id](#delete_auth_users_invalidation_by_id) - Remove invalidation for user ID
...
with CriblSDKPythonFafo(
    ...
    cspf_client.auth.get_auth_authorization_code_callback()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.get_auth_metadata()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.login(username="Nikko.Connelly", password="Ljp4BunfMR9hNyM")
...
with CriblSDKPythonFafo(
    ...
    cspf_client.auth.create_auth_slo_callback()
...
with CriblSDKPythonFafo(
    ...
    cspf_client.auth.get_auth_slo_callback()
...
with CriblSDKPythonFafo(
    ...
    cspf_client.auth.create_auth_sso_callback()
...
with CriblSDKPythonFafo(
    ...
    cspf_client.auth.get_auth_sso_callback()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.get_auth_sso()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.get_auth_groups()
...
**[models.GetAuthGroupsResponse](../../models/getauthgroupsresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.get_auth_multi_factor()
...
**[models.GetAuthMultiFactorResponse](../../models/getauthmultifactorresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.delete_auth_users_token_by_id(id="<id>")
...
**[models.DeleteAuthUsersTokenByIDResponse](../../models/deleteauthuserstokenbyidresponse.md)**
...
## delete_auth_users_invalidation_by_id
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.auth.delete_auth_users_invalidation_by_id(id="<id>")
...
**[models.DeleteAuthUsersInvalidationByIDResponse](../../models/deleteauthusersinvalidationbyidresponse.md)**
