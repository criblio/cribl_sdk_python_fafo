...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.saved_jobs.list_saved_job()
...
**[models.ListSavedJobResponse](../../models/listsavedjobresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.saved_jobs.create_saved_job(request={
        "type": models.SavedJobCollectionJobType.COLLECTION,
        "ttl": "4h",
...
**[models.CreateSavedJobResponse](../../models/createsavedjobresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.saved_jobs.get_saved_job_by_id(id="<id>")
...
**[models.GetSavedJobByIDResponse](../../models/getsavedjobbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.saved_jobs.update_saved_job_by_id(id="<id>", saved_job={
        "type": models.SavedJobCollectionJobType.COLLECTION,
        "ttl": "4h",
        "ignore_group_jobs_limit": False,
        "resume_on_boot": False,
...
**[models.UpdateSavedJobByIDResponse](../../models/updatesavedjobbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.saved_jobs.delete_saved_job_by_id(id="<id>")
...
**[models.DeleteSavedJobByIDResponse](../../models/deletesavedjobbyidresponse.md)**
