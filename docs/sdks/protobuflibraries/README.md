...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.protobuflibraries.get_protobuf_library_config(only_with_encodings="<value>")
...
**[models.GetProtobufLibraryConfigResponse](../../models/getprotobuflibraryconfigresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.protobuflibraries.get_protobuf_library_config_by_id(id="<id>")
...
**[models.GetProtobufLibraryConfigByIDResponse](../../models/getprotobuflibraryconfigbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.protobuflibraries.get_protobuf_library_config_encodings_by_id_and_enc_id(id="<id>", encid="<id>")
...
**[models.GetProtobufLibraryConfigEncodingsByIDAndEncIDResponse](../../models/getprotobuflibraryconfigencodingsbyidandencidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.protobuflibraries.get_protobuf_library_config_encodings_by_id(id="<id>")
...
**[models.GetProtobufLibraryConfigEncodingsByIDResponse](../../models/getprotobuflibraryconfigencodingsbyidresponse.md)**
