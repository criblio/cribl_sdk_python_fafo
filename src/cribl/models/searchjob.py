...
EarliestTypedDict = TypeAliasType("EarliestTypedDict", Union[str, float])


Earliest = TypeAliasType("Earliest", Union[str, float])


LatestTypedDict = TypeAliasType("LatestTypedDict", Union[str, float])


Latest = TypeAliasType("Latest", Union[str, float])
...
class SearchJobTypedDict(TypedDict):
    ...
    earliest: NotRequired[EarliestTypedDict]
    ...
    latest: NotRequired[LatestTypedDict]
...
class SearchJob(BaseModel):
    ...
    earliest: Optional[Earliest] = None
