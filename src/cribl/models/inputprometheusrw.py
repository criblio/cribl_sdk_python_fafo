...
class InputPrometheusRwConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputPrometheusRwConnections(BaseModel):
    output: str
...
class InputPrometheusRwMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputPrometheusRwMetadata(BaseModel):
    name: str
...
class InputPrometheusRwOauthParamsTypedDict(TypedDict):
    name: str
...
class InputPrometheusRwOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class InputPrometheusRwOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class InputPrometheusRwOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class InputPrometheusRwTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputPrometheusRwConnectionsTypedDict]]
    ...
    r"""Remote Write authentication type"""
    metadata: NotRequired[List[InputPrometheusRwMetadataTypedDict]]
    ...
    oauth_params: NotRequired[List[InputPrometheusRwOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[InputPrometheusRwOauthHeadersTypedDict]]
...
class InputPrometheusRw(BaseModel):
    ...
    connections: Optional[List[InputPrometheusRwConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputPrometheusRwMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    oauth_params: Annotated[
        Optional[List[InputPrometheusRwOauthParams]],
        pydantic.Field(alias="oauthParams"),
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[InputPrometheusRwOauthHeaders]],
