...
class InputS3ConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputS3Connections(BaseModel):
    output: str
...
class InputS3MetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputS3Metadata(BaseModel):
    name: str
...
class InputS3TypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputS3ConnectionsTypedDict]]
...
class InputS3(BaseModel):
    ...
    connections: Optional[List[InputS3Connections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputS3Metadata]] = None
    r"""Fields to add to events from this input"""
