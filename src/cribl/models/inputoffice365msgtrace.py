...
class InputOffice365MsgTraceConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputOffice365MsgTraceConnections(BaseModel):
    output: str
...
class InputOffice365MsgTraceMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputOffice365MsgTraceMetadata(BaseModel):
    name: str
...
class InputOffice365MsgTraceTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputOffice365MsgTraceConnectionsTypedDict]]
...
class InputOffice365MsgTrace(BaseModel):
    ...
    connections: Optional[List[InputOffice365MsgTraceConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
