...
class OutputCriblLakeServerSideEncryption(str, Enum):
...
class OutputCriblLakeTypedDict(TypedDict):
    ...
    r"""Storage class to select for uploaded objects."""
    server_side_encryption: NotRequired[OutputCriblLakeServerSideEncryption]
    r"""Server-side encryption for uploaded objects."""
...
class OutputCriblLake(BaseModel):
    ...
    server_side_encryption: Annotated[
        Optional[OutputCriblLakeServerSideEncryption],
