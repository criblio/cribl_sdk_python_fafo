...
class OutputElasticCloudExtraParamsTypedDict(TypedDict):
    name: str
    r"""Field name"""
    value: str
    r"""Field value"""
...
class OutputElasticCloudExtraParams(BaseModel):
    name: str
    r"""Field name"""
...
class OutputElasticCloudResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputElasticCloudResponseRetrySettings(BaseModel):
...
class OutputElasticCloudTypedDict(TypedDict):
    ...
    extra_params: NotRequired[List[OutputElasticCloudExtraParamsTypedDict]]
    ...
    r"""Toggle to No when sending events to an Elastic TSDS (time series data stream)"""
    response_retry_settings: NotRequired[
        List[OutputElasticCloudResponseRetrySettingsTypedDict]
    ]
...
class OutputElasticCloud(BaseModel):
    ...
    extra_params: Annotated[
        Optional[List[OutputElasticCloudExtraParams]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputElasticCloudResponseRetrySettings]],
