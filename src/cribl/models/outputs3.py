...
class OutputS3KeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputS3KeyValueMetadata(BaseModel):
    value: str
...
class OutputS3TypedDict(TypedDict):
    ...
    object_acl: NotRequired[ObjectACL]
    r"""Object ACL to assign to uploaded objects."""
    ...
    compress: NotRequired[OutputS3Compress]
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: NotRequired[List[OutputS3KeyValueMetadataTypedDict]]
...
class OutputS3(BaseModel):
    ...
    object_acl: Annotated[Optional[ObjectACL], pydantic.Field(alias="objectACL")] = (
        ObjectACL.PRIVATE
    )
    r"""Object ACL to assign to uploaded objects."""

    storage_class: Annotated[
        Optional[StorageClass], pydantic.Field(alias="storageClass")
    ] = None
    r"""Storage class to select for uploaded objects."""
    ...
    compress: Optional[OutputS3Compress] = OutputS3Compress.GZIP
    r"""Choose data compression format to apply before moving files to final destination"""
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputS3KeyValueMetadata]],
