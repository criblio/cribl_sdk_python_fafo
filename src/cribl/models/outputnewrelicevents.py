...
class OutputNewrelicEventsResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputNewrelicEventsResponseRetrySettings(BaseModel):
...
class OutputNewrelicEventsTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputNewrelicEventsResponseRetrySettingsTypedDict]
    ]
...
class OutputNewrelicEvents(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputNewrelicEventsResponseRetrySettings]],
