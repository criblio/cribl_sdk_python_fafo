...
class InputMetricsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputMetricsConnections(BaseModel):
    output: str
...
class InputMetricsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputMetricsMetadata(BaseModel):
    name: str
...
class InputMetricsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputMetricsConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputMetricsMetadataTypedDict]]
...
class InputMetrics(BaseModel):
    ...
    connections: Optional[List[InputMetricsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputMetricsMetadata]] = None
    r"""Fields to add to events from this input"""
