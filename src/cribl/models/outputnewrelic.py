...
class OutputNewrelicMetadataTypedDict(TypedDict):
    name: FieldName
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class OutputNewrelicMetadata(BaseModel):
    name: FieldName
...
class OutputNewrelicExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    name: NotRequired[str]


class OutputNewrelicExtraHTTPHeaders(BaseModel):
    value: str
...
class OutputNewrelicResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputNewrelicResponseRetrySettings(BaseModel):
...
class OutputNewrelicTypedDict(TypedDict):
    ...
    metadata: NotRequired[List[OutputNewrelicMetadataTypedDict]]
    ...
    extra_http_headers: NotRequired[List[OutputNewrelicExtraHTTPHeadersTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputNewrelicResponseRetrySettingsTypedDict]
    ]
...
class OutputNewrelic(BaseModel):
    ...
    metadata: Optional[List[OutputNewrelicMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputNewrelicExtraHTTPHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputNewrelicResponseRetrySettings]],
