...
class InputCriblTCPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCriblTCPConnections(BaseModel):
    output: str
...
class InputCriblTCPMetadata(BaseModel):
    name: str
...
class InputCriblTCPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCriblTCPConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputCriblTCPMetadataTypedDict]]
...
class InputCriblTCP(BaseModel):
    ...
    connections: Optional[List[InputCriblTCPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCriblTCPMetadata]] = None
    r"""Fields to add to events from this input"""
