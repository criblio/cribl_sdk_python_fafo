...
class DiskSpaceProtection(str, Enum):
...
class KeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]
...
class OutputFilesystemTypedDict(TypedDict):
    ...
    on_disk_full_backpressure: NotRequired[DiskSpaceProtection]
    r"""Whether to block or drop events when disk space is below the global 'Min free disk space' limit"""
    description: NotRequired[str]
    compress: NotRequired[Compress]
    r"""Choose data compression format to apply before moving files to final destination"""
    compression_level: NotRequired[CompressionLevel]
    r"""Compression level to apply before moving files to final destination"""
    automatic_schema: NotRequired[bool]
    r"""Automatically calculate the schema based on the events of each Parquet file generated"""
    parquet_version: NotRequired[ParquetVersion]
    r"""Determines which data types are supported and how they are represented"""
    parquet_data_page_version: NotRequired[DataPageVersion]
    r"""Serialization format of data pages. Note that some reader implementations use Data page V2's attributes to work more efficiently, while others ignore it."""
    ...
    key_value_metadata: NotRequired[List[KeyValueMetadataTypedDict]]
    r"""The metadata of files the Destination writes will include the properties you add here as key-value pairs. Useful for tagging, e.g., \"key\":\"OCSF Event Class\", \"value\":\"9001\"."""
...
class OutputFilesystem(BaseModel):
    ...
    format_: Annotated[Optional[DataFormat], pydantic.Field(alias="format")] = (
        DataFormat.JSON
    )
    r"""Format of the output data"""
    ...
    on_disk_full_backpressure: Annotated[
        Optional[DiskSpaceProtection], pydantic.Field(alias="onDiskFullBackpressure")
    ] = DiskSpaceProtection.BLOCK
    r"""Whether to block or drop events when disk space is below the global 'Min free disk space' limit"""

    description: Optional[str] = None

    compress: Optional[Compress] = Compress.GZIP
    r"""Choose data compression format to apply before moving files to final destination"""

    compression_level: Annotated[
        Optional[CompressionLevel], pydantic.Field(alias="compressionLevel")
    ...
    parquet_version: Annotated[
        Optional[ParquetVersion], pydantic.Field(alias="parquetVersion")
    ] = ParquetVersion.PARQUET_2_6
    r"""Determines which data types are supported and how they are represented"""

    parquet_data_page_version: Annotated[
        Optional[DataPageVersion], pydantic.Field(alias="parquetDataPageVersion")
    ] = DataPageVersion.DATA_PAGE_V2
    r"""Serialization format of data pages. Note that some reader implementations use Data page V2's attributes to work more efficiently, while others ignore it."""
    ...
    key_value_metadata: Annotated[
        Optional[List[KeyValueMetadata]], pydantic.Field(alias="keyValueMetadata")
    ] = None
    r"""The metadata of files the Destination writes will include the properties you add here as key-value pairs. Useful for tagging, e.g., \"key\":\"OCSF Event Class\", \"value\":\"9001\"."""
