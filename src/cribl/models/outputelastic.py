...
class OutputElasticExtraHTTPHeadersTypedDict(TypedDict):
    value: str
    name: NotRequired[str]


class OutputElasticExtraHTTPHeaders(BaseModel):
    value: str
...
class OutputElasticResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputElasticResponseRetrySettings(BaseModel):
...
class OutputElasticUrlsTypedDict(TypedDict):
    url: str
...
class OutputElasticUrls(BaseModel):
    url: str
    r"""The URL to an Elastic node to send events to. Example: http://elastic:9200/_bulk"""
...
class OutputElasticTypedDict(TypedDict):
    ...
    extra_http_headers: NotRequired[List[OutputElasticExtraHTTPHeadersTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputElasticResponseRetrySettingsTypedDict]
    ]
    ...
    extra_params: NotRequired[List[ExtraParamsTypedDict]]
    r"""Extra Parameters."""
    ...
    r"""Toggle this off when sending events to an Elastic TSDS (time series data stream) or to allow Elastic to generate document IDs"""
    ...
    urls: NotRequired[List[OutputElasticUrlsTypedDict]]
...
class OutputElastic(BaseModel):
    ...
    extra_http_headers: Annotated[
        Optional[List[OutputElasticExtraHTTPHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputElasticResponseRetrySettings]],
    ...
    extra_params: Annotated[
        Optional[List[ExtraParams]], pydantic.Field(alias="extraParams")
    ] = None
    r"""Extra Parameters."""
    ...
    urls: Optional[List[OutputElasticUrls]] = None
