...
class ClickHouse(BaseSDK):
    ...
    def create_output_click_house_describe_table(
        ...
        *,
        ...
        column_mappings: Optional[
            Union[
                List[models.CHOutConfigColumnMapping],
                List[models.CHOutConfigColumnMappingTypedDict],
            ]
        ] = None,
        ...
        urls: Optional[
            Union[List[models.CHOutConfigURL], List[models.CHOutConfigURLTypedDict]]
        ] = None,
    ...
    ) -> models.CreateOutputClickHouseDescribeTableResponse:
        ...
        request = models.CHOutConfig(
            ...
            column_mappings=utils.get_pydantic_model(
                column_mappings, Optional[List[models.CHOutConfigColumnMapping]]
            ),
            compress=compress,
            ...
            url=url,
            urls=utils.get_pydantic_model(urls, Optional[List[models.CHOutConfigURL]]),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CreateOutputClickHouseDescribeTableResponse
            )
