...
class InputEdgePrometheusConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputEdgePrometheusConnections(BaseModel):
    output: str
...
class InputEdgePrometheusCompression(str, Enum):
...
class InputEdgePrometheusPqTypedDict(TypedDict):
    ...
    compress: NotRequired[InputEdgePrometheusCompression]
    r"""Codec to use to compress the persisted data"""
...
class InputEdgePrometheusPq(BaseModel):
    ...
    compress: Optional[InputEdgePrometheusCompression] = (
        InputEdgePrometheusCompression.NONE
    )
    r"""Codec to use to compress the persisted data"""
...
class DiskSpoolingTypedDict(TypedDict):
...
class InputEdgePrometheusMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputEdgePrometheusMetadata(BaseModel):
    name: str
...
class InputEdgePrometheusAuthenticationMethod(str, Enum):
...
class InputEdgePrometheusTargetsProtocol(str, Enum):
...
class TargetsTypedDict(TypedDict):
    host: str
    r"""Name of host from which to pull metrics."""
    protocol: NotRequired[InputEdgePrometheusTargetsProtocol]
    r"""Protocol to use when collecting metrics"""
...
class Targets(BaseModel):
    ...
    protocol: Optional[InputEdgePrometheusTargetsProtocol] = (
        InputEdgePrometheusTargetsProtocol.HTTP
    )
    r"""Protocol to use when collecting metrics"""
...
class InputEdgePrometheusProtocol(str, Enum):
    r"""Protocol to use when collecting metrics"""
...
class InputEdgePrometheusTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputEdgePrometheusConnectionsTypedDict]]
    ...
    persistence: NotRequired[DiskSpoolingTypedDict]
    metadata: NotRequired[List[InputEdgePrometheusMetadataTypedDict]]
    r"""Fields to add to events from this input"""
    auth_type: NotRequired[InputEdgePrometheusAuthenticationMethod]
    r"""Enter credentials directly, or select a stored secret"""
    description: NotRequired[str]
    targets: NotRequired[List[TargetsTypedDict]]
    name_list: NotRequired[List[str]]
    r"""List of DNS names to resolve"""
    record_type: NotRequired[InputEdgePrometheusRecordType]
    r"""DNS Record type to resolve"""
    scrape_protocol: NotRequired[InputEdgePrometheusProtocol]
    r"""Protocol to use when collecting metrics"""
...
class InputEdgePrometheus(BaseModel):
    ...
    connections: Optional[List[InputEdgePrometheusConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    persistence: Optional[DiskSpooling] = None

    metadata: Optional[List[InputEdgePrometheusMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    scrape_protocol: Annotated[
        Optional[InputEdgePrometheusProtocol], pydantic.Field(alias="scrapeProtocol")
    ] = InputEdgePrometheusProtocol.HTTP
    r"""Protocol to use when collecting metrics"""
