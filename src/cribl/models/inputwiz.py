...
class InputWizConnections(BaseModel):
    output: str
...
class InputWizMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputWizMetadata(BaseModel):
    name: str
...
class InputWizTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputWizConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputWizMetadataTypedDict]]
...
class InputWiz(BaseModel):
    ...
    connections: Optional[List[InputWizConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputWizMetadata]] = None
    r"""Fields to add to events from this input"""
