...
class EventBreakerRuleParser4Type(str, Enum):
    KVP = "kvp"
...
class FourTypedDict(TypedDict):
    mode: ParserMode
    src_field: str
    type: EventBreakerRuleParser4Type
...
class EventBreakerRuleParser3Type(str, Enum):
    JSON = "json"
...
class ThreeTypedDict(TypedDict):
    mode: ParserMode
    src_field: str
    type: EventBreakerRuleParser3Type
    clean_fields: NotRequired[List[str]]
    dst_field: NotRequired[str]
    field_filter_expr: NotRequired[str]
    fields: NotRequired[List[str]]
...
class EventBreakerRuleParserType(str, Enum):
    GROK = "grok"


class Parser2TypedDict(TypedDict):
    mode: ParserMode
    src_field: str
    type: EventBreakerRuleParserType
    dst_field: NotRequired[str]
...
class Parser1TypedDict(TypedDict):
    mode: ParserMode
    src_field: str
    type: ParserType
    allowed_key_chars: NotRequired[bool]
...
ParserTypedDict = TypeAliasType(
    "ParserTypedDict",
    Union[Parser2TypedDict, ThreeTypedDict, Parser1TypedDict, FourTypedDict],
)


Parser = TypeAliasType("Parser", Union[Parser2, Three, Parser1, Four])
...
class TimestampTimezone2TypedDict(TypedDict):
    name: str
    offsets: List[float]
    untils: List[float]


class TimestampTimezone2(BaseModel):
    name: str
...
TimestampTimezoneTypedDict = TypeAliasType(
    "TimestampTimezoneTypedDict", Union[TimestampTimezone2TypedDict, str]
)


TimestampTimezone = TypeAliasType("TimestampTimezone", Union[TimestampTimezone2, str])
...
class EventBreakerRuleTypedDict(TypedDict):
    ...
    timestamp_timezone: TimestampTimezoneTypedDict
    ...
    parser: NotRequired[ParserTypedDict]
...
class EventBreakerRule(BaseModel):
    ...
    timestamp_timezone: Annotated[
        TimestampTimezone, pydantic.Field(alias="timestampTimezone")
    ]
