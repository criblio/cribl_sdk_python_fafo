...
class InputModelDrivenTelemetryConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputModelDrivenTelemetryConnections(BaseModel):
    output: str
...
class InputModelDrivenTelemetryMetadata(BaseModel):
    name: str
...
class InputModelDrivenTelemetryTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputModelDrivenTelemetryConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputModelDrivenTelemetryMetadataTypedDict]]
...
class InputModelDrivenTelemetry(BaseModel):
    ...
    connections: Optional[List[InputModelDrivenTelemetryConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputModelDrivenTelemetryMetadata]] = None
    r"""Fields to add to events from this input"""
