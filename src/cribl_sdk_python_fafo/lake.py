...
class Lake(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CreateCriblLakeDatasetByLakeIDResponse
            )
    ...
    def get_cribl_lake_dataset_by_lake_id(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetCriblLakeDatasetByLakeIDResponse
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.ErrorData)
            raise errors.Error(data=response_data)
    ...
    def delete_cribl_lake_dataset_by_lake_id_and_id(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.DeleteCriblLakeDatasetByLakeIDAndIDResponse
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.ErrorData)
            raise errors.Error(data=response_data)
    ...
    def get_cribl_lake_dataset_by_lake_id_and_id(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetCriblLakeDatasetByLakeIDAndIDResponse
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.ErrorData)
            raise errors.Error(data=response_data)
    ...
    def update_cribl_lake_dataset_by_lake_id_and_id(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.UpdateCriblLakeDatasetByLakeIDAndIDResponse
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.ErrorData)
            raise errors.Error(data=response_data)
