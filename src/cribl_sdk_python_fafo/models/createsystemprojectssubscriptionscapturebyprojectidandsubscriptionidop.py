...
class CreateSystemProjectsSubscriptionsCaptureByProjectIDAndSubscriptionIDResponseTypedDict(
    TypedDict
):
...
class CreateSystemProjectsSubscriptionsCaptureByProjectIDAndSubscriptionIDResponse(
    BaseModel
):
    r"""a list of any objects"""
