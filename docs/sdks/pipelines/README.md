...
* [get_pipeline_by_pack](#get_pipeline_by_pack) - Get a list of Pipeline objects within a Pack
* [create_pipeline_by_pack](#create_pipeline_by_pack) - Create Pipeline within a Pack
* [get_pipeline_by_pack_and_id](#get_pipeline_by_pack_and_id) - Get Pipeline by ID within a Pack
* [update_pipeline_by_pack_and_id](#update_pipeline_by_pack_and_id) - Update Pipeline within a Pack
* [delete_pipeline_by_pack_and_id](#delete_pipeline_by_pack_and_id) - Delete Pipeline within a Pack
...
with Cribl(
    ...
    res = c_client.pipelines.get_system_projects_pipelines_by_group_id_and_project_id(group_id="<id>", project_id="<id>")
...
with Cribl(
    ...
    res = c_client.pipelines.create_system_projects_pipelines_by_group_id_and_project_id(group_id="<id>", project_id="<id>", id="<id>", conf={})
...
with Cribl(
    ...
    res = c_client.pipelines.get_system_projects_pipelines_by_group_id_and_project_id_and_pipeline_id(group_id="<id>", project_id="<id>", pipeline_id="<id>")
...
with Cribl(
    ...
    res = c_client.pipelines.update_system_projects_pipelines_by_group_id_and_project_id_and_pipeline_id(group_id="<id>", project_id="<id>", pipeline_id="<id>", id="<id>", conf={})
...
with Cribl(
    ...
    res = c_client.pipelines.delete_system_projects_pipelines_by_group_id_and_project_id_and_pipeline_id(group_id="<id>", project_id="<id>", pipeline_id="<id>")
...
with Cribl(
    ...
    res = c_client.pipelines.list_pipeline()
...
**[models.ListPipelineResponseBody](../../models/listpipelineresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.create_pipeline(id="<id>", conf={})
...
**[models.CreatePipelineResponseBody](../../models/createpipelineresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.get_pipeline_by_id(id="<id>")
...
**[models.GetPipelineByIDResponseBody](../../models/getpipelinebyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.update_pipeline_by_id(id_param="<value>", id="<id>", conf={})
...
**[models.UpdatePipelineByIDResponseBody](../../models/updatepipelinebyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.delete_pipeline_by_id(id="<id>")
...
**[models.DeletePipelineByIDResponseBody](../../models/deletepipelinebyidresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.get_pipeline_by_pack(pack="<value>")
...
**[models.GetPipelineByPackResponseBody](../../models/getpipelinebypackresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.create_pipeline_by_pack(pack="<value>", id="<id>", conf={})
...
**[models.CreatePipelineByPackResponseBody](../../models/createpipelinebypackresponsebody.md)**
...
with Cribl(
    ...
    res = c_client.pipelines.get_pipeline_by_pack_and_id(id="<id>", pack="<value>")
...
**[models.GetPipelineByPackAndIDResponseBody](../../models/getpipelinebypackandidresponsebody.md)**
...
## update_pipeline_by_pack_and_id
...
with Cribl(
    ...
    res = c_client.pipelines.update_pipeline_by_pack_and_id(id_param="<value>", pack="<value>", id="<id>", conf={})
...
**[models.UpdatePipelineByPackAndIDResponseBody](../../models/updatepipelinebypackandidresponsebody.md)**
...
## delete_pipeline_by_pack_and_id
...
with Cribl(
    ...
    res = c_client.pipelines.delete_pipeline_by_pack_and_id(id="<id>", pack="<value>")
...
**[models.DeletePipelineByPackAndIDResponseBody](../../models/deletepipelinebypackandidresponsebody.md)**
