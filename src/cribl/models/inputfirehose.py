...
class InputFirehoseConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputFirehoseConnections(BaseModel):
    output: str
...
class InputFirehoseMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputFirehoseMetadata(BaseModel):
    name: str
...
class InputFirehoseTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputFirehoseConnectionsTypedDict]]
...
class InputFirehose(BaseModel):
    ...
    connections: Optional[List[InputFirehoseConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputFirehoseMetadata]] = None
    r"""Fields to add to events from this input"""
