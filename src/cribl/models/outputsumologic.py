...
class OutputSumoLogicResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputSumoLogicResponseRetrySettings(BaseModel):
...
class OutputSumoLogicTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputSumoLogicResponseRetrySettingsTypedDict]
    ]
...
class OutputSumoLogic(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputSumoLogicResponseRetrySettings]],
