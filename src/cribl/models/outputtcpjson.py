...
class OutputTcpjsonHostsTypedDict(TypedDict):
    host: str
...
class OutputTcpjsonHosts(BaseModel):
    host: str
    r"""The hostname of the receiver."""
...
class OutputTcpjsonTypedDict(TypedDict):
    ...
    hosts: NotRequired[List[OutputTcpjsonHostsTypedDict]]
...
class OutputTcpjson(BaseModel):
    ...
    hosts: Optional[List[OutputTcpjsonHosts]] = None
    r"""Set of hosts to load-balance data to."""
