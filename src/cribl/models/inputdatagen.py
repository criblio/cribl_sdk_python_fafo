...
class InputDatagenConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputDatagenConnections(BaseModel):
    output: str
...
class InputDatagenMetadata(BaseModel):
    name: str
...
class InputDatagenTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputDatagenConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputDatagenPqTypedDict]
    metadata: NotRequired[List[InputDatagenMetadataTypedDict]]
...
class InputDatagen(BaseModel):
    ...
    connections: Optional[List[InputDatagenConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputDatagenPq] = None

    metadata: Optional[List[InputDatagenMetadata]] = None
    r"""Fields to add to events from this input"""
