...
class InputOffice365ServiceConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputOffice365ServiceConnections(BaseModel):
    output: str
...
class InputOffice365ServiceMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputOffice365ServiceMetadata(BaseModel):
    name: str
...
class InputOffice365ServiceTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputOffice365ServiceConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputOffice365ServiceMetadataTypedDict]]
...
class InputOffice365Service(BaseModel):
    ...
    connections: Optional[List[InputOffice365ServiceConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputOffice365ServiceMetadata]] = None
    r"""Fields to add to events from this input"""
