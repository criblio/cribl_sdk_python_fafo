...
```shell
uvx --from cribl-sdk-python-fafo python
```
...
| -------------- | ------ | ------------ | --------------------------------- |
| `bearer_auth`  | http   | HTTP Bearer  | `CRIBLSDKPYTHONFAFO_BEARER_AUTH`  |
| `client_oauth` | oauth2 | OAuth2 token | `CRIBLSDKPYTHONFAFO_CLIENT_OAUTH` |
...
### [ai_settings](docs/sdks/aisettings/README.md)

* [get_ai_settings_features_by_feature](docs/sdks/aisettings/README.md#get_ai_settings_features_by_feature) - Returns setting for a specific feature
* [create_ai_settings_features_by_feature](docs/sdks/aisettings/README.md#create_ai_settings_features_by_feature) - Updates setting for a specific feature
* [get_ai_settings_features](docs/sdks/aisettings/README.md#get_ai_settings_features) - Returns all feature settings
* [create_ai_settings_features](docs/sdks/aisettings/README.md#create_ai_settings_features) - Updates all AI settings at once
...
* [get_auth_authorization_code_callback](docs/sdks/authsdk/README.md#get_auth_authorization_code_callback) - API call that the IDP should use for an authorization code callback
* [get_auth_metadata](docs/sdks/authsdk/README.md#get_auth_metadata) - Obtain metadata which Cribl Stream/Edge uses when acting as a Service Provider
* [login](docs/sdks/authsdk/README.md#login) - Log in and obtain Auth token
* [logout](docs/sdks/authsdk/README.md#logout) - Log current user out
* [create_auth_slo_callback](docs/sdks/authsdk/README.md#create_auth_slo_callback) - API call that the IDP should use for a logout request
* [get_auth_slo_callback](docs/sdks/authsdk/README.md#get_auth_slo_callback) - Accepts a logout request from an IDP and logs out the user
* [get_auth_slo](docs/sdks/authsdk/README.md#get_auth_slo) - Redirect user to IDP with logout request
* [create_auth_sso_callback](docs/sdks/authsdk/README.md#create_auth_sso_callback) - API call that the IDP should use for an authentication request
* [get_auth_sso_callback](docs/sdks/authsdk/README.md#get_auth_sso_callback) - Accepts an authentication request from an IDP and authenticates the user
* [get_auth_sso](docs/sdks/authsdk/README.md#get_auth_sso) - Obtain redirect information
* [get_auth_groups](docs/sdks/authsdk/README.md#get_auth_groups) - List the external authentication system's groups
* [get_auth_multi_factor](docs/sdks/authsdk/README.md#get_auth_multi_factor) - Get PIV configuration
* [delete_auth_users_token_by_id](docs/sdks/authsdk/README.md#delete_auth_users_token_by_id) - Invalidate token(s) for user *id*
* [delete_auth_users_invalidation_by_id](docs/sdks/authsdk/README.md#delete_auth_users_invalidation_by_id) - Remove invalidation for user ID
...
* [list_collector](docs/sdks/collectorssdk/README.md#list_collector) - Get a list of Collector objects
* [get_collector_by_id](docs/sdks/collectorssdk/README.md#get_collector_by_id) - Get Collector by ID
...
### [distributed](docs/sdks/distributedsdk/README.md)

* [get_summary_workers](docs/sdks/distributedsdk/README.md#get_summary_workers) - get worker and edge nodes count
* [get_workers](docs/sdks/distributedsdk/README.md#get_workers) - get worker and edge nodes
* [update_workers_restart](docs/sdks/distributedsdk/README.md#update_workers_restart) - restarts worker nodes
* [get_config_bundles_by_group_and_version](docs/sdks/distributedsdk/README.md#get_config_bundles_by_group_and_version) - Download config bundle (used by remote nodes)
* [get_summary](docs/sdks/distributedsdk/README.md#get_summary) - Get summary of Distributed deployment
...
* [create_edge_file_ingest](docs/sdks/filesdk/README.md#create_edge_file_ingest) - Ingest a specified file through a specified pipeline to a specified destination or send to routes.
...
### [git](docs/sdks/gitsdk/README.md)

* [get_system_projects_version_count_by_group_id_and_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_count_by_group_id_and_project_id) - Get the count of files of changed
* [get_system_projects_version_diff_by_group_id_and_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_diff_by_group_id_and_project_id) - Get the textual diff for given commit
* [get_system_projects_version_files_by_group_id_and_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_files_by_group_id_and_project_id) - Get the files changed
* [create_system_projects_version_commit_by_group_id_and_project_id](docs/sdks/gitsdk/README.md#create_system_projects_version_commit_by_group_id_and_project_id) - Commit project changes
* [create_system_projects_version_commit_by_project_id](docs/sdks/gitsdk/README.md#create_system_projects_version_commit_by_project_id) - Commit project changes.
* [get_system_projects_version_count_by_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_count_by_project_id) - get the count of files of changed
* [get_system_projects_version_diff_by_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_diff_by_project_id) - get the textual diff for given commit
* [get_system_projects_version_files_by_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_files_by_project_id) - get the files changed
* [create_system_projects_version_revert_by_project_id](docs/sdks/gitsdk/README.md#create_system_projects_version_revert_by_project_id) - Revert project changes.
* [get_system_projects_version_show_by_project_id](docs/sdks/gitsdk/README.md#get_system_projects_version_show_by_project_id) - Show project changes.
* [get_system_settings_git_settings](docs/sdks/gitsdk/README.md#get_system_settings_git_settings) - Get git settings
* [update_system_settings_git_settings](docs/sdks/gitsdk/README.md#update_system_settings_git_settings) - Update git settings
* [undo_last_commit](docs/sdks/gitsdk/README.md#undo_last_commit) - undo the last commit
* [get_version_branch](docs/sdks/gitsdk/README.md#get_version_branch) - get the list of branches
* [create_version_commit](docs/sdks/gitsdk/README.md#create_version_commit) - create a new commit containing the current configs the given log message describing the changes.
* [get_version_count](docs/sdks/gitsdk/README.md#get_version_count) - get the count of files of changed
* [get_version_current_branch](docs/sdks/gitsdk/README.md#get_version_current_branch) - returns git branch that the config is checked out to, if any
* [get_version_diff](docs/sdks/gitsdk/README.md#get_version_diff) - get the textual diff for given commit
* [get_version_files](docs/sdks/gitsdk/README.md#get_version_files) - get the files changed
* [get_version_info](docs/sdks/gitsdk/README.md#get_version_info) - Get info about versioning availability
* [create_version_push](docs/sdks/gitsdk/README.md#create_version_push) - push the current configs to the remote repository.
* [create_version_revert](docs/sdks/gitsdk/README.md#create_version_revert) - revert a commit
* [get_version_show](docs/sdks/gitsdk/README.md#get_version_show) - get the log message and textual diff for given commit
* [get_version_status](docs/sdks/gitsdk/README.md#get_version_status) - get the the working tree status
* [create_version_sync](docs/sdks/gitsdk/README.md#create_version_sync) - syncs with remote repo via POST requests
...
* [get_health_info](docs/sdks/healthsdk/README.md#get_health_info) - Provides health info for REST server
...
* [list_io_metrics_entry](docs/sdks/iometrics/README.md#list_io_metrics_entry) - Get a list of IoMetricsEntry objects
* [get_io_metrics_entry_by_id](docs/sdks/iometrics/README.md#get_io_metrics_entry_by_id) - Get IoMetricsEntry by ID
* [update_io_metrics_entry_by_id](docs/sdks/iometrics/README.md#update_io_metrics_entry_by_id) - Update IoMetricsEntry
* [delete_io_metrics_entry_by_id](docs/sdks/iometrics/README.md#delete_io_metrics_entry_by_id) - Delete IoMetricsEntry
...
### [notifications](docs/sdks/notificationssdk/README.md)

* [list_notification](docs/sdks/notificationssdk/README.md#list_notification) - Get a list of Notification objects
* [create_notification](docs/sdks/notificationssdk/README.md#create_notification) - Create Notification
* [get_notification_by_id](docs/sdks/notificationssdk/README.md#get_notification_by_id) - Get Notification by ID
* [update_notification_by_id](docs/sdks/notificationssdk/README.md#update_notification_by_id) - Update Notification
* [delete_notification_by_id](docs/sdks/notificationssdk/README.md#delete_notification_by_id) - Delete Notification

### [only_on_prem](docs/sdks/onlyonprem/README.md)

* [list_user](docs/sdks/onlyonprem/README.md#list_user) - Get a list of User objects
* [create_user](docs/sdks/onlyonprem/README.md#create_user) - Create User
* [get_user_by_id](docs/sdks/onlyonprem/README.md#get_user_by_id) - Get User by ID
* [update_user_by_id](docs/sdks/onlyonprem/README.md#update_user_by_id) - Update User properties – admin use only
* [delete_user_by_id](docs/sdks/onlyonprem/README.md#delete_user_by_id) - Delete User
* [update_user_info_by_id](docs/sdks/onlyonprem/README.md#update_user_info_by_id) - Update User except for their roles
...
* [get_packs_refs_by_id](docs/sdks/packs/README.md#get_packs_refs_by_id) - Returns all entities that reference objects from outside of the pack
* [get_packs_export_by_id](docs/sdks/packs/README.md#get_packs_export_by_id) - Export Pack
* [create_packs_publish_by_id](docs/sdks/packs/README.md#create_packs_publish_by_id) - Publish Pack back to its repository
...
* [get_search_query](docs/sdks/query/README.md#get_search_query) - Runs the query and returns the results
...
### [samples](docs/sdks/samplessdk/README.md)

* [create_system_projects_subscriptions_capture_by_group_id_and_subscription_id](docs/sdks/samplessdk/README.md#create_system_projects_subscriptions_capture_by_group_id_and_subscription_id) - Capture live incoming data from a particular Project and Subscription at the Subscription
* [create_system_projects_capture_by_group_id_and_project_id](docs/sdks/samplessdk/README.md#create_system_projects_capture_by_group_id_and_project_id) - Capture live incoming data from a particular Project and Subscription at the Destination
* [create_system_projects_preview_by_group_id_and_project_id](docs/sdks/samplessdk/README.md#create_system_projects_preview_by_group_id_and_project_id) - Sends sample events through a Pipeline  for specified Project and returns the results
* [list_data_sample](docs/sdks/samplessdk/README.md#list_data_sample) - Get a list of DataSample objects
* [create_data_sample](docs/sdks/samplessdk/README.md#create_data_sample) - Create DataSample
* [get_data_sample_by_id](docs/sdks/samplessdk/README.md#get_data_sample_by_id) - Get DataSample by ID
* [update_data_sample_by_id](docs/sdks/samplessdk/README.md#update_data_sample_by_id) - Update DataSample
* [delete_data_sample_by_id](docs/sdks/samplessdk/README.md#delete_data_sample_by_id) - Delete DataSample
* [get_data_sample_content_by_id](docs/sdks/samplessdk/README.md#get_data_sample_content_by_id) - Get sample content by ID
* [create_system_capture](docs/sdks/samplessdk/README.md#create_system_capture) - Capture live incoming data
* [create_system_projects_capture_by_project_id](docs/sdks/samplessdk/README.md#create_system_projects_capture_by_project_id) - Capture live incoming data from a particular project and subscription at the destination
* [create_system_projects_subscriptions_capture_by_project_id_and_subscription_id](docs/sdks/samplessdk/README.md#create_system_projects_subscriptions_capture_by_project_id_and_subscription_id) - Capture live incoming data from a particular project and subscription at the subscription
* [create_preview](docs/sdks/samplessdk/README.md#create_preview) - Sends sample events through a pipeline and returns the results
...
* [get_search_job_settings_by_id](docs/sdks/search/README.md#get_search_job_settings_by_id) - Get search job settings
* [create_search_job_settings_by_id](docs/sdks/search/README.md#create_search_job_settings_by_id) - Save search job settings
* [get_search_job_status_by_id](docs/sdks/search/README.md#get_search_job_status_by_id) - Get job status
* [get_search_job_timeline_by_id](docs/sdks/search/README.md#get_search_job_timeline_by_id) - Get search timeline
* [get_search_job_field_summaries_by_id](docs/sdks/search/README.md#get_search_job_field_summaries_by_id) - List field summaries
...
* [get_search_docs](docs/sdks/search/README.md#get_search_docs) - Get Search documentation
...
* [get_search_jobs_diag_by_id](docs/sdks/search/README.md#get_search_jobs_diag_by_id) - Get full search job data
* [get_search_jobs_logs_by_id_and_filename](docs/sdks/search/README.md#get_search_jobs_logs_by_id_and_filename) - Get the contents of a log file
...
### [security](docs/sdks/securitysdk/README.md)

* [get_security_kms_config](docs/sdks/securitysdk/README.md#get_security_kms_config) - Get Cribl KMS config
* [update_security_kms_config](docs/sdks/securitysdk/README.md#update_security_kms_config) - Update Cribl KMS config
* [get_security_kms_health](docs/sdks/securitysdk/README.md#get_security_kms_health) - Get Cribl KMS health
...
### [system](docs/sdks/systemsdk/README.md)

* [update_changelog_viewed](docs/sdks/systemsdk/README.md#update_changelog_viewed) - Update changelog viewed state
* [create_system_distributed_upgrade_cancel_by_group](docs/sdks/systemsdk/README.md#create_system_distributed_upgrade_cancel_by_group) - Cancel a running group upgrade
* [create_system_distributed_upgrade_stage_by_group](docs/sdks/systemsdk/README.md#create_system_distributed_upgrade_stage_by_group) - Stage distributed group upgrade
* [create_system_distributed_upgrade_by_group](docs/sdks/systemsdk/README.md#create_system_distributed_upgrade_by_group) - Execute distributed group upgrade
* [get_system_distributed_upgrade_download_by_file](docs/sdks/systemsdk/README.md#get_system_distributed_upgrade_download_by_file) - Get the previously downloaded Cribl package
* [reload_settings](docs/sdks/systemsdk/README.md#reload_settings) - Reload Cribl settings from the filesystem
* [trigger_restart](docs/sdks/systemsdk/README.md#trigger_restart) - Restart Cribl server
* [get_system_settings_auth](docs/sdks/systemsdk/README.md#get_system_settings_auth) - Get authentication settings
* [update_system_settings_auth](docs/sdks/systemsdk/README.md#update_system_settings_auth) - Update authentication settings
* [get_system_settings_conf](docs/sdks/systemsdk/README.md#get_system_settings_conf) - Get Cribl system settings
* [update_system_settings_conf](docs/sdks/systemsdk/README.md#update_system_settings_conf) - Update Cribl system settings
* [get_system_settings_git_settings](docs/sdks/systemsdk/README.md#get_system_settings_git_settings) - Get git settings
* [update_system_settings_git_settings](docs/sdks/systemsdk/README.md#update_system_settings_git_settings) - Update git settings
* [get_system_settings_search_limits](docs/sdks/systemsdk/README.md#get_system_settings_search_limits) - Get search limits
* [~~get_system_settings~~](docs/sdks/systemsdk/README.md#get_system_settings) - Get Cribl system settings. Deprecated: use specific endpoints /system/limits, /system/job-limits, /system/redis-cache-limits, /system/services-limits, /system/settings/git-settings, and /system/settings/conf respectively :warning: **Deprecated**
* [~~update_system_settings~~](docs/sdks/systemsdk/README.md#update_system_settings) - Update Cribl system settings. Deprecated: use specific endpoints /system/limits, /system/job-limits, /system/settings/git-settings, /system/settings/auth and /system/settings/conf respectively :warning: **Deprecated**
* [get_system_settings_cribl](docs/sdks/systemsdk/README.md#get_system_settings_cribl) - Get public settings visible to any logged user
* [get_system_settings_upgrade](docs/sdks/systemsdk/README.md#get_system_settings_upgrade) - Get a list of Cribl versions available for upgrade
* [create_system_settings_upgrade_by_version](docs/sdks/systemsdk/README.md#create_system_settings_upgrade_by_version) - Upgrade Cribl to a given version
* [create_system_settings_upgrade_from_package](docs/sdks/systemsdk/README.md#create_system_settings_upgrade_from_package) - Upgrade master node with the provided package
...
```python
from cribl_sdk_python_fafo import CriblSDKPythonFafo, models
from cribl_sdk_python_fafo.utils import BackoffStrategy, RetryConfig
import os
...
```python
from cribl_sdk_python_fafo import CriblSDKPythonFafo, errors, models
import os
...
s = CriblSDKPythonFafo(client=http_client)
```

or you could wrap the client with your own custom logic:
```python
from cribl_sdk_python_fafo import CriblSDKPythonFafo
from cribl_sdk_python_fafo.httpclient import AsyncHttpClient
import httpx
...
s = CriblSDKPythonFafo(async_client=CustomClient(httpx.AsyncClient()))
```
...
s = CriblSDKPythonFafo(server_url="https://example.com", debug_logger=logging.getLogger("cribl_sdk_python_fafo"))
```

You can also enable a default debug logger by setting an environment variable `CRIBLSDKPYTHONFAFO_DEBUG` to true.
<!-- End Debugging [debug] -->
