...
class InputExecConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputExecConnections(BaseModel):
    output: str
...
class InputExecMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputExecMetadata(BaseModel):
    name: str
...
class InputExecTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputExecConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputExecMetadataTypedDict]]
...
class InputExec(BaseModel):
    ...
    connections: Optional[List[InputExecConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputExecMetadata]] = None
    r"""Fields to add to events from this input"""
