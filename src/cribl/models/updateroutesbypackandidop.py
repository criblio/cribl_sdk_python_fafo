...
from .routes_input import Routes, RoutesInput, RoutesInputTypedDict, RoutesTypedDict
...
class UpdateRoutesByPackAndIDResponseBodyTypedDict(TypedDict):
...
class UpdateRoutesByPackAndIDResponseBody(BaseModel):
    r"""a list of Routes objects"""
