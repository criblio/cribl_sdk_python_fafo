...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.list_input()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.create_input(request={
        "disabled": False,
        "send_to_routes": True,
        "pq_enabled": False,
        "host": "0.0.0.0",
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.get_input_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.update_input_by_id(id="<id>", input_={
        "id": "<id>",
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.delete_input_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.create_input_hec_token_by_id(id="<id>", token="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.update_input_hec_token_by_id_and_token(id="<id>", token="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.list_input_status()
...
**[models.ListInputStatusResponse](../../models/listinputstatusresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.inputs.get_input_status_by_id(id="<id>")
...
**[models.GetInputStatusByIDResponse](../../models/getinputstatusbyidresponse.md)**
