...
class Groups(BaseSDK):
        ...
        *,
    ...
    ) -> models.GetGroupsConfigVersionByIDResponseBody:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetGroupsConfigVersionByIDResponseBody
            )
    ...
    def create_products_groups_by_product(
        self,
        *,
        product: models.CreateProductsGroupsByProductPathParamProduct,
        config_version: str,
        id: str,
        cloud: Optional[
        ...
        git: Optional[Union[models.GitModel, models.GitModelTypedDict]] = None,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.CreateProductsGroupsByProductResponseBody:
        ...
        request = models.CreateProductsGroupsByProductRequest(
            ...
            config_group=models.ConfigGroup(
                ...
                git=utils.get_pydantic_model(git, Optional[models.GitModel]),
                id=id,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CreateProductsGroupsByProductResponseBody
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, models.ErrorData)
            raise models.Error(data=response_data)
    ...
    def get_products_groups_by_product(
        self,
        *,
        product: models.GetProductsGroupsByProductPathParamProduct,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetProductsGroupsByProductResponseBody
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, models.ErrorData)
            raise models.Error(data=response_data)
    ...
    def update_groups_deploy_by_id(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.UpdateGroupsDeployByIDResponseBody:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.UpdateGroupsDeployByIDResponseBody
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, models.ErrorData)
            raise models.Error(data=response_data)
    ...
    def get_groups_by_id(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetGroupsByIDResponseBody:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GetGroupsByIDResponseBody)
        if utils.match_response(http_res, "500", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, models.ErrorData)
            raise models.Error(data=response_data)
        if utils.match_response(http_res, ["401", "4XX"], "*"):
