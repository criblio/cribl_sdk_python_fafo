...
class DeleteIoMetricsConfigByIDRequestTypedDict(TypedDict):
    id: str
    r"""Unique ID to DELETE"""


class DeleteIoMetricsConfigByIDRequest(BaseModel):
    id: Annotated[
...
class DeleteIoMetricsConfigByIDResponseBodyTypedDict(TypedDict):
...
class DeleteIoMetricsConfigByIDResponseBody(BaseModel):
    r"""a list of IoMetricsConfig objects"""
