...
class InputPrometheusConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputPrometheusConnections(BaseModel):
    output: str
...
class InputPrometheusMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputPrometheusMetadata(BaseModel):
    name: str
...
class InputPrometheusAuthenticationMethod(str, Enum):
...
class InputPrometheusTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputPrometheusConnectionsTypedDict]]
    ...
    discovery_type: NotRequired[DiscoveryType]
    r"""Target discovery mechanism. Use static to manually enter a list of targets."""
    ...
    search_filter: NotRequired[List[SearchFilterTypedDict]]
...
class InputPrometheus(BaseModel):
    ...
    connections: Optional[List[InputPrometheusConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    discovery_type: Annotated[
        Optional[DiscoveryType], pydantic.Field(alias="discoveryType")
    ...
    auth_type: Annotated[
        Optional[InputPrometheusAuthenticationMethod], pydantic.Field(alias="authType")
    ] = InputPrometheusAuthenticationMethod.MANUAL
    r"""Enter credentials directly, or select a stored secret"""
    ...
    record_type: Annotated[Optional[RecordType], pydantic.Field(alias="recordType")] = (
        RecordType.SRV
    )
    r"""DNS Record type to resolve"""
    ...
    search_filter: Annotated[
        Optional[List[SearchFilter]], pydantic.Field(alias="searchFilter")
    ] = None
    r"""EC2 Instance Search Filter"""
