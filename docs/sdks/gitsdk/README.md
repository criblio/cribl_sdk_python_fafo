...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_count_by_group_id_and_project_id(group_id="<id>", project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_diff_by_group_id_and_project_id(group_id="<id>", project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_files_by_group_id_and_project_id(group_id="<id>", project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_system_projects_version_commit_by_group_id_and_project_id(group_id="<id>", project_id="<id>", message="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_system_projects_version_commit_by_project_id(project_id="<id>", message="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_count_by_project_id(project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_diff_by_project_id(project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_files_by_project_id(project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_system_projects_version_revert_by_project_id(project_id="<id>", message="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_projects_version_show_by_project_id(project_id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_system_settings_git_settings()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.update_system_settings_git_settings()
...
with CriblSDKPythonFafo(
    ...
    cspf_client.git.undo_last_commit()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_branch()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_version_commit(message="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_count()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_current_branch()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_diff()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_files()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_info()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_version_push()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_version_revert(commit="<value>", message="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_show()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.get_version_status()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.git.create_version_sync()
