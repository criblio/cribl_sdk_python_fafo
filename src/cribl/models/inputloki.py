...
class InputLokiConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputLokiConnections(BaseModel):
    output: str
...
class InputLokiMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputLokiMetadata(BaseModel):
    name: str
...
class InputLokiOauthParamsTypedDict(TypedDict):
    name: str
...
class InputLokiOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class InputLokiOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class InputLokiOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class InputLokiTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputLokiConnectionsTypedDict]]
    ...
    r"""Loki logs authentication type"""
    metadata: NotRequired[List[InputLokiMetadataTypedDict]]
    ...
    oauth_params: NotRequired[List[InputLokiOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[InputLokiOauthHeadersTypedDict]]
...
class InputLoki(BaseModel):
    ...
    connections: Optional[List[InputLokiConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputLokiMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    oauth_params: Annotated[
        Optional[List[InputLokiOauthParams]], pydantic.Field(alias="oauthParams")
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[InputLokiOauthHeaders]], pydantic.Field(alias="oauthHeaders")
    ] = None
    r"""Additional headers to send in the OAuth login request. @{product} will automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
