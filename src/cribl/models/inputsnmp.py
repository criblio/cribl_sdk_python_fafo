...
class InputSnmpConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSnmpConnections(BaseModel):
    output: str
...
class V3UsersTypedDict(TypedDict):
    name: str
...
class SNMPv3AuthenticationTypedDict(TypedDict):
    ...
    v3_users: NotRequired[List[V3UsersTypedDict]]
...
class SNMPv3Authentication(BaseModel):
    ...
    v3_users: Annotated[Optional[List[V3Users]], pydantic.Field(alias="v3Users")] = None
    r"""User credentials for receiving v3 traps"""


class InputSnmpMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSnmpMetadata(BaseModel):
    name: str
...
class InputSnmpTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSnmpConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputSnmpMetadataTypedDict]]
...
class InputSnmp(BaseModel):
    ...
    connections: Optional[List[InputSnmpConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputSnmpMetadata]] = None
    r"""Fields to add to events from this input"""
