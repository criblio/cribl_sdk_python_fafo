...
class InputKafkaConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputKafkaConnections(BaseModel):
    output: str
...
class InputKafkaMetadata(BaseModel):
    name: str
...
class InputKafkaTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputKafkaConnectionsTypedDict]]
...
class InputKafka(BaseModel):
    ...
    connections: Optional[List[InputKafkaConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    tls: Optional[TLSSettingsClientSide] = None
