...
class GetGroupsACLByIDQueryParamType(str, Enum):
...
class GetGroupsACLByIDRequestTypedDict(TypedDict):
    id: str
    r"""Group id"""
    type: NotRequired[GetGroupsACLByIDQueryParamType]
    r"""resource type by which to filter access levels"""
...
class GetGroupsACLByIDRequest(BaseModel):
    ...
    type: Annotated[
        Optional[GetGroupsACLByIDQueryParamType],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""resource type by which to filter access levels"""


class GetGroupsACLByIDResponseBodyTypedDict(TypedDict):
...
class GetGroupsACLByIDResponseBody(BaseModel):
    r"""a list of UserAccessControlList objects"""
