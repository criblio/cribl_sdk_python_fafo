...
class InputWinEventLogsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputWinEventLogsConnections(BaseModel):
    output: str
...
class InputWinEventLogsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputWinEventLogsMetadata(BaseModel):
    name: str
...
class InputWinEventLogsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputWinEventLogsConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputWinEventLogsMetadataTypedDict]]
...
class InputWinEventLogs(BaseModel):
    ...
    connections: Optional[List[InputWinEventLogsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputWinEventLogsMetadata]] = None
    r"""Fields to add to events from this input"""
