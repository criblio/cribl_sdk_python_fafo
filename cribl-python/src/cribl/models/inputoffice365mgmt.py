...
class InputOffice365MgmtConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputOffice365MgmtConnections(BaseModel):
    output: str
...
class InputOffice365MgmtMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputOffice365MgmtMetadata(BaseModel):
    name: str
...
class ContentConfigTypedDict(TypedDict):
...
class InputOffice365MgmtTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputOffice365MgmtConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputOffice365MgmtMetadataTypedDict]]
    ...
    content_config: NotRequired[List[ContentConfigTypedDict]]
...
class InputOffice365Mgmt(BaseModel):
    ...
    connections: Optional[List[InputOffice365MgmtConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    ] = SubscriptionPlan.ENTERPRISE_GCC
    r"""Office 365 subscription plan for your organization, typically Office 365 Enterprise"""
    ...
    metadata: Optional[List[InputOffice365MgmtMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    content_config: Annotated[
        Optional[List[ContentConfig]], pydantic.Field(alias="contentConfig")
    ] = None
    r"""Enable Office 365 Management Activity API content types and polling intervals. Polling intervals are used to set up search date range and cron schedule, e.g.: */${interval} * * * *. Because of this, intervals entered must be evenly divisible by 60 to give a predictable schedule."""
