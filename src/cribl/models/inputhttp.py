...
class InputHTTPConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputHTTPConnections(BaseModel):
    output: str
...
class InputHTTPMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputHTTPMetadata(BaseModel):
    name: str
...
class InputHTTPAuthTokensExtMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputHTTPAuthTokensExtMetadata(BaseModel):
    name: str
...
class AuthTokensExtTypedDict(TypedDict):
    ...
    metadata: NotRequired[List[InputHTTPAuthTokensExtMetadataTypedDict]]
...
class AuthTokensExt(BaseModel):
    ...
    metadata: Optional[List[InputHTTPAuthTokensExtMetadata]] = None
    r"""Fields to add to events referencing this token"""
...
class InputHTTPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputHTTPConnectionsTypedDict]]
    ...
    r"""Absolute path on which to listen for the Cribl HTTP API requests. At the moment, only _bulk (default /cribl/_bulk) is available. Use empty string to disable."""
    ...
    metadata: NotRequired[List[InputHTTPMetadataTypedDict]]
...
class InputHTTP(BaseModel):
    ...
    connections: Optional[List[InputHTTPConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputHTTPMetadata]] = None
    r"""Fields to add to events from this input"""
