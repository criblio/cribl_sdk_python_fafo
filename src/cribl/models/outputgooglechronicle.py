...
class OutputGoogleChronicleResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputGoogleChronicleResponseRetrySettings(BaseModel):
...
class ExtraLogTypesTypedDict(TypedDict):
    log_type: str
    r"""Log type"""
...
class CustomLabelsTypedDict(TypedDict):
    key: str
    r"""Label key"""
    value: str
    r"""Label value"""
...
class OutputGoogleChronicleTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputGoogleChronicleResponseRetrySettingsTypedDict]
    ]
    ...
    description: NotRequired[str]
    extra_log_types: NotRequired[List[ExtraLogTypesTypedDict]]
    ...
    custom_labels: NotRequired[List[CustomLabelsTypedDict]]
...
class OutputGoogleChronicle(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputGoogleChronicleResponseRetrySettings]],
    ...
    extra_log_types: Annotated[
        Optional[List[ExtraLogTypes]], pydantic.Field(alias="extraLogTypes")
    ] = None
    r"""Custom log types. If the value \"Custom\" is selected in the setting \"Default log type\" above, the first custom log type in this table will be automatically selected as default log type."""
    ...
    custom_labels: Annotated[
        Optional[List[CustomLabels]], pydantic.Field(alias="customLabels")
    ] = None
    r"""Custom labels to be added to every batch."""
