...
class InputKubeMetricsConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputKubeMetricsConnections(BaseModel):
    output: str
...
class InputKubeMetricsRulesTypedDict(TypedDict):
    filter_: str
...
class InputKubeMetricsRules(BaseModel):
...
class InputKubeMetricsMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputKubeMetricsMetadata(BaseModel):
    name: str
...
class InputKubeMetricsPersistenceCompression(str, Enum):
...
class InputKubeMetricsPersistenceTypedDict(TypedDict):
    ...
    compress: NotRequired[InputKubeMetricsPersistenceCompression]
    r"""Select data compression format. Optional."""
...
class InputKubeMetricsPersistence(BaseModel):
    ...
    compress: Optional[InputKubeMetricsPersistenceCompression] = (
        InputKubeMetricsPersistenceCompression.GZIP
    )
    r"""Select data compression format. Optional."""
...
class InputKubeMetricsTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputKubeMetricsConnectionsTypedDict]]
    ...
    rules: NotRequired[List[InputKubeMetricsRulesTypedDict]]
    ...
    metadata: NotRequired[List[InputKubeMetricsMetadataTypedDict]]
...
class InputKubeMetrics(BaseModel):
    ...
    connections: Optional[List[InputKubeMetricsConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    rules: Optional[List[InputKubeMetricsRules]] = None
    r"""Add rules to decide which Kubernetes objects to generate metrics for. Events are generated if no rules are given or of all the rules' expressions evaluate to true."""

    metadata: Optional[List[InputKubeMetricsMetadata]] = None
    r"""Fields to add to events from this input"""
