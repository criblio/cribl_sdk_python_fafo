...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDResponseBodyTypedDict(
    TypedDict
):
...
class CreateSystemProjectsPipelinesByGroupIDAndProjectIDResponseBody(BaseModel):
    r"""A list of Pipeline objects for specified Project"""
