...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.users_acl.get_dataset_acl_by_id(id="<id>")
...
**[models.GetDatasetACLByIDResponse](../../models/getdatasetaclbyidresponse.md)**
...
with CriblSDKPythonFafo(
    ...
    cspf_client.users_acl.create_dataset_acl_apply_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.users_acl.get_search_dashboard_acl_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    cspf_client.users_acl.create_search_dashboard_acl_apply_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.users_acl.get_project_acl_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    cspf_client.users_acl.create_project_acl_apply_by_id(id="<id>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.users_acl.get_groups_acl_by_id(id="<id>")
