...
class InputFileConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputFileConnections(BaseModel):
    output: str
...
class InputFileMetadataTypedDict(TypedDict):
    name: str
    value: str
...
class InputFileTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputFileConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputFileMetadataTypedDict]]
...
class InputFile(BaseModel):
    ...
    connections: Optional[List[InputFileConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputFileMetadata]] = None
    r"""Fields to add to events from this input"""
