...
class OutputClickHouseMappingType(str, Enum):
...
class OutputClickHouseResponseRetrySettingsTypedDict(TypedDict):
    http_status: float
...
class OutputClickHouseResponseRetrySettings(BaseModel):
...
class OutputClickHouseOauthParamsTypedDict(TypedDict):
    name: str
...
class OutputClickHouseOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class OutputClickHouseOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class OutputClickHouseOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class ColumnMappingsTypedDict(TypedDict):
    column_name: str
...
class OutputClickHouseTypedDict(TypedDict):
    ...
    response_retry_settings: NotRequired[
        List[OutputClickHouseResponseRetrySettingsTypedDict]
    ]
    ...
    oauth_params: NotRequired[List[OutputClickHouseOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[OutputClickHouseOauthHeadersTypedDict]]
    ...
    column_mappings: NotRequired[List[ColumnMappingsTypedDict]]
...
class OutputClickHouse(BaseModel):
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputClickHouseResponseRetrySettings]],
    ...
    oauth_params: Annotated[
        Optional[List[OutputClickHouseOauthParams]], pydantic.Field(alias="oauthParams")
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[OutputClickHouseOauthHeaders]],
    ...
    column_mappings: Annotated[
        Optional[List[ColumnMappings]], pydantic.Field(alias="columnMappings")
    ] = None
