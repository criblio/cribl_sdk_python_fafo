...
class OutputDynatraceOtlpCompression(str, Enum):
...
class OutputDynatraceOtlpMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputDynatraceOtlpMetadata(BaseModel):
    value: str
...
class OutputDynatraceOtlpResponseRetrySettings(BaseModel):
...
class OutputDynatraceOtlpTypedDict(TypedDict):
    ...
    r"""The version of OTLP Protobuf definitions to use when structuring data to send"""
    compress: NotRequired[OutputDynatraceOtlpCompression]
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: NotRequired[List[OutputDynatraceOtlpMetadataTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputDynatraceOtlpResponseRetrySettingsTypedDict]
    ]
...
class OutputDynatraceOtlp(BaseModel):
    ...
    compress: Optional[OutputDynatraceOtlpCompression] = (
        OutputDynatraceOtlpCompression.GZIP
    )
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: Optional[List[OutputDynatraceOtlpMetadata]] = None
    r"""List of key-value pairs to send with each gRPC request. Value supports JavaScript expressions that are evaluated just once, when the destination gets started. To pass credentials as metadata, use 'C.Secret'."""
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputDynatraceOtlpResponseRetrySettings]],
