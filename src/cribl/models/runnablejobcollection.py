...
class RunnableJobCollectionScheduleType(str, Enum):
    COLLECTION = "collection"
...
class RunnableJobCollectionRunSettingsTypedDict(TypedDict):
    type: NotRequired[RunnableJobCollectionScheduleType]
...
class RunnableJobCollectionRunSettings(BaseModel):
    type: Optional[RunnableJobCollectionScheduleType] = None
...
class RunnableJobCollectionCollectorSpecificSettingsTypedDict(TypedDict):
    pass


class RunnableJobCollectionCollectorSpecificSettings(BaseModel):
    pass
...
class RunnableJobCollectionMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class RunnableJobCollectionMetadata(BaseModel):
    name: str
...
class RunnableJobCollectionInputTypedDict(TypedDict):
    ...
    metadata: NotRequired[List[RunnableJobCollectionMetadataTypedDict]]
...
class RunnableJobCollectionInput(BaseModel):
    ...
    metadata: Optional[List[RunnableJobCollectionMetadata]] = None
    r"""Fields to add to events from this input"""
