...
class InputCrowdstrikeConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCrowdstrikeConnections(BaseModel):
    output: str
...
class InputCrowdstrikeMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCrowdstrikeMetadata(BaseModel):
    name: str
...
class InputCrowdstrikeTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCrowdstrikeConnectionsTypedDict]]
...
class InputCrowdstrike(BaseModel):
    ...
    connections: Optional[List[InputCrowdstrikeConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputCrowdstrikeMetadata]] = None
    r"""Fields to add to events from this input"""
