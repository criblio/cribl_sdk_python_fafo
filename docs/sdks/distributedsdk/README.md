...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.distributed.get_summary_workers()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.distributed.get_workers()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.distributed.update_workers_restart()
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.distributed.get_config_bundles_by_group_and_version(group="<value>", version="<value>")
...
with CriblSDKPythonFafo(
    ...
    res = cspf_client.distributed.get_summary()
