...
class OutputOpenTelemetryMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputOpenTelemetryMetadata(BaseModel):
    value: str
...
class OutputOpenTelemetryOauthParamsTypedDict(TypedDict):
    name: str
...
class OutputOpenTelemetryOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class OutputOpenTelemetryOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class OutputOpenTelemetryOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class OutputOpenTelemetryResponseRetrySettings(BaseModel):
...
class OutputOpenTelemetryTypedDict(TypedDict):
    ...
    r"""The version of OTLP Protobuf definitions to use when structuring data to send"""
    compress: NotRequired[OutputOpenTelemetryCompression]
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: NotRequired[List[OutputOpenTelemetryMetadataTypedDict]]
    ...
    oauth_params: NotRequired[List[OutputOpenTelemetryOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[OutputOpenTelemetryOauthHeadersTypedDict]]
    ...
    response_retry_settings: NotRequired[
        List[OutputOpenTelemetryResponseRetrySettingsTypedDict]
    ]
...
class OutputOpenTelemetry(BaseModel):
    ...
    compress: Optional[OutputOpenTelemetryCompression] = (
        OutputOpenTelemetryCompression.GZIP
    )
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    metadata: Optional[List[OutputOpenTelemetryMetadata]] = None
    r"""List of key-value pairs to send with each gRPC request. Value supports JavaScript expressions that are evaluated just once, when the destination gets started. To pass credentials as metadata, use 'C.Secret'."""
    ...
    oauth_params: Annotated[
        Optional[List[OutputOpenTelemetryOauthParams]],
        pydantic.Field(alias="oauthParams"),
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[OutputOpenTelemetryOauthHeaders]],
    ...
    response_retry_settings: Annotated[
        Optional[List[OutputOpenTelemetryResponseRetrySettings]],
