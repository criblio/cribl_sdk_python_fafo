...
class InputSplunkConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSplunkConnections(BaseModel):
    output: str
...
class InputSplunkPq(BaseModel):
    ...
    compress: Optional[InputSplunkCompression] = InputSplunkCompression.NONE
    r"""Codec to use to compress the persisted data"""
...
class InputSplunkMetadata(BaseModel):
    name: str
...
class AuthTokensTypedDict(TypedDict):
    token: str
...
class InputSplunkTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSplunkConnectionsTypedDict]]
    ...
    metadata: NotRequired[List[InputSplunkMetadataTypedDict]]
    r"""Fields to add to events from this input"""
    breaker_rulesets: NotRequired[List[str]]
    r"""A list of event-breaking rulesets that will be applied, in order, to the input data stream"""
    stale_channel_flush_ms: NotRequired[float]
    r"""How long (in milliseconds) the Event Breaker will wait for new data to be sent to a specific channel before flushing the data stream out, as is, to the Pipelines"""
    auth_tokens: NotRequired[List[AuthTokensTypedDict]]
    r"""Shared secrets to be provided by any Splunk forwarder. If empty, unauthorized access is permitted."""
...
class InputSplunk(BaseModel):
    ...
    connections: Optional[List[InputSplunkConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputSplunkMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    auth_tokens: Annotated[
        Optional[List[AuthTokens]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Shared secrets to be provided by any Splunk forwarder. If empty, unauthorized access is permitted."""
