...
class InputOpenTelemetryConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputOpenTelemetryConnections(BaseModel):
    output: str
...
class InputOpenTelemetryMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputOpenTelemetryMetadata(BaseModel):
    name: str
...
class InputOpenTelemetryOauthParamsTypedDict(TypedDict):
    name: str
...
class InputOpenTelemetryOauthParams(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class InputOpenTelemetryOauthHeadersTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class InputOpenTelemetryOauthHeaders(BaseModel):
    name: str
    r"""OAuth header name"""
...
class InputOpenTelemetryTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputOpenTelemetryConnectionsTypedDict]]
    ...
    r"""OpenTelemetry authentication type"""
    metadata: NotRequired[List[InputOpenTelemetryMetadataTypedDict]]
    ...
    oauth_params: NotRequired[List[InputOpenTelemetryOauthParamsTypedDict]]
    ...
    oauth_headers: NotRequired[List[InputOpenTelemetryOauthHeadersTypedDict]]
...
class InputOpenTelemetry(BaseModel):
    ...
    connections: Optional[List[InputOpenTelemetryConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    otlp_version: Annotated[
        Optional[OTLPVersion], pydantic.Field(alias="otlpVersion")
    ...
    metadata: Optional[List[InputOpenTelemetryMetadata]] = None
    r"""Fields to add to events from this input"""
    ...
    oauth_params: Annotated[
        Optional[List[InputOpenTelemetryOauthParams]],
        pydantic.Field(alias="oauthParams"),
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""

    oauth_headers: Annotated[
        Optional[List[InputOpenTelemetryOauthHeaders]],
