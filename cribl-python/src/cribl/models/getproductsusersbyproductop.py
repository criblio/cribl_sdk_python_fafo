...
class GetProductsUsersByProductPathParamProduct(str, Enum):
...
class GetProductsUsersByProductRequestTypedDict(TypedDict):
    product: GetProductsUsersByProductPathParamProduct
    r"""product by which to filter members"""
...
class GetProductsUsersByProductResponseBodyTypedDict(TypedDict):
...
class GetProductsUsersByProductResponseBody(BaseModel):
    r"""a list of User objects"""
