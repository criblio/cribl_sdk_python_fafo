...
class GetProjectACLByIDRequestTypedDict(TypedDict):
    id: str
    r"""Unique ID for ACL Get"""


class GetProjectACLByIDRequest(BaseModel):
    id: Annotated[
...
class GetProjectACLByIDResponseTypedDict(TypedDict):
...
class GetProjectACLByIDResponse(BaseModel):
    r"""a list of UserAccessControlList objects"""
