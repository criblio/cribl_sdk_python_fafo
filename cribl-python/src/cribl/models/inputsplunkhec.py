...
class InputSplunkHecConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSplunkHecConnections(BaseModel):
    output: str
...
class InputSplunkHecAuthTokensMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSplunkHecAuthTokensMetadata(BaseModel):
    name: str
...
class InputSplunkHecAuthTokensTypedDict(TypedDict):
    token: Any
    ...
    metadata: NotRequired[List[InputSplunkHecAuthTokensMetadataTypedDict]]
    r"""Fields to add to events referencing this token"""


class InputSplunkHecAuthTokens(BaseModel):
    token: Any
    ...
    metadata: Optional[List[InputSplunkHecAuthTokensMetadata]] = None
    r"""Fields to add to events referencing this token"""
...
class InputSplunkHecMetadata(BaseModel):
    name: str
...
class InputSplunkHecTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSplunkHecConnectionsTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputSplunkHecPqTypedDict]
    host: NotRequired[str]
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    auth_tokens: NotRequired[List[InputSplunkHecAuthTokensTypedDict]]
    ...
    metadata: NotRequired[List[InputSplunkHecMetadataTypedDict]]
...
class InputSplunkHec(BaseModel):
    ...
    connections: Optional[List[InputSplunkHecConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    auth_tokens: Annotated[
        Optional[List[InputSplunkHecAuthTokens]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    ...
    metadata: Optional[List[InputSplunkHecMetadata]] = None
    r"""Fields to add to every event. Overrides fields added at the token or request level. See [the Source documentation](https://docs.cribl.io/stream/sources-splunk-hec/#fields) for more info."""
