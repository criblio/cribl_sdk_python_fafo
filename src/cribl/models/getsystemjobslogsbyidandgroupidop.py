...
class GetSystemJobsLogsByIDAndGroupIDRequestTypedDict(TypedDict):
    id: str
    r"""Job id"""
    group_id: str
    r"""Group ID (optional)"""
...
class GetSystemJobsLogsByIDAndGroupIDRequest(BaseModel):
    id: Annotated[
...
class GetSystemJobsLogsByIDAndGroupIDResponseBodyTypedDict(TypedDict):
...
class GetSystemJobsLogsByIDAndGroupIDResponseBody(BaseModel):
    r"""a list of any objects"""
