...
class OutputMinioKeyValueMetadataTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputMinioKeyValueMetadata(BaseModel):
    value: str
...
class OutputMinioTypedDict(TypedDict):
    ...
    key_value_metadata: NotRequired[List[OutputMinioKeyValueMetadataTypedDict]]
...
class OutputMinio(BaseModel):
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputMinioKeyValueMetadata]],
