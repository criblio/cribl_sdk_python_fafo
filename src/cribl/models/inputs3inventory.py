...
class InputS3InventoryConnectionsTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputS3InventoryConnections(BaseModel):
    output: str
...
class InputS3InventoryMetadataTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputS3InventoryMetadata(BaseModel):
    name: str
...
class InputS3InventoryTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputS3InventoryConnectionsTypedDict]]
...
class InputS3Inventory(BaseModel):
    ...
    connections: Optional[List[InputS3InventoryConnections]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    ...
    metadata: Optional[List[InputS3InventoryMetadata]] = None
    r"""Fields to add to events from this input"""
